...
export const PRINCIPLES = [
  ...
  { id: 12, name: 'Equipotentiality', hint: 'Limit position changes; eliminate lifting/lowering work.', auto: 'Design assembly sequence so the pack never needs re-orientation — deletes a £1.7M turnover fixture.' },
  ...
  { id: 20, name: 'Continuity of useful action', hint: 'Work without idle runs; all parts at full load.', auto: 'Balance the line so the £153/hr HPDC cell never waits; combine left/right parts in one die to fill press strokes.' },
  ...
  { id: 26, name: 'Copying', hint: 'Use cheap copies instead of expensive/fragile objects.', auto: 'Vision-based virtual gauge replaces £68k check fixture; digital-twin trial assembly replaces two prototype loops.' },
  ...
  { id: 32, name: 'Colour changes', hint: 'Change colour/transparency; use additives for observation.', auto: 'Mould-in-colour deletes the paint process (−£6.8-13/part); UV-fluorescent sealant enables automated inspection.' },
