...
export const DFM_RULES = [
  ...
  },
  {
    ...
    measure: 'sfsaSandToleranceMargin',
    compare: 'gte',
    threshold: 1.0,
    unit: 'x SFSA 2000 capability',
    rationale:
  ...
  },
  {
    ...
    measure: 'sfsaInvToleranceMargin',
    compare: 'gte',
    threshold: 1.0,
    unit: 'x CT5-7 capability',
    rationale:
  ...
  },
  {
    ...
    process: 'sand-casting',
    severity: 'low',
    title: 'Flatness callout tighter than sand casting holds',
    measure: 'sfsaSandFlatnessMargin',
    compare: 'gte',
    threshold: 1.0,
    unit: 'x CTG7 flatness',
    rationale:
  ...
  {
    id: 'inv-flatness-capability',
    sourceStatus: 'standard-named',
    process: 'investment-casting',
    severity: 'low',
    title: 'Flatness callout tighter than investment casting holds',
    measure: 'sfsaInvFlatnessMargin',
    compare: 'gte',
    threshold: 1.0,
    unit: 'x CTG6 flatness',
    rationale:
  ...
  {
    id: 'sand-machining-stock',
    sourceStatus: 'standard-named',
    process: 'sand-casting',
    severity: 'medium',
    title: 'Machining stock below the required machining allowance',
    measure: 'sfsaMachiningStockMargin',
    compare: 'gte',
    threshold: 1.0,
    unit: 'x Table 2.2 RMA',
    rationale:
