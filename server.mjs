...
// ─── 800V Battery Pack Thermal, HV, BMS, Safety (bev051–100) ──────────────────
{
  ...
  const bev51Ideas = [
    ...
    { id:'bev097', title:'Structural foam fill in pack perimeter frame replaces separate NVH absorber strips', system:'Pack Structural & NVH', costSavingType:'Complexity + Weight', annualSaving:'€480k', difficulty:'Low', timeToImplement:'6–9 months', description:'Separate NVH foam strips in pack frame (PE foam, 20 mm × 10 mm section, 3.6 m perimeter run, 0.28 kg, €3.80/vehicle) + structural foam fill for battery enclosure rigidity are separate processes. Two-component structural foam (Dow BETAFORCE 1440, density 280 kg/m³, E-mod 80 MPa): injected into frame cavity post-assembly — provides both structural rigidity (+18% torsional stiffness) and NVH damping (−4 dB interior noise at 200 Hz). NVH strips deleted: €3.80/vehicle. Structural foam: €6.40/vehicle. Net: +€2.60/vehicle material. Labour saving: 1 operation (foam injection) replaces 2 (foam strip + structural foam): −€1.20/vehicle. Mass: −0.28 + 0.41 kg net = +0.13 kg (small). Net VAVE: −€1.40/vehicle. At NVH strip standard cost €8.40 (premium foam): positive. Conservative €480k at 40k/yr when applied to higher-cost NVH foam specification.', submittedBy:'BEV Structural VAVE', verified:0, stars:71 },
    { id:'bev098', title:'Battery pack mount right-sizing from 6-point to 4-point reduces mount hardware cost €18/vehicle', system:'Pack Structural & NVH', costSavingType:'Complexity', annualSaving:'€720k', difficulty:'Low', timeToImplement:'6–9 months', description:'6-point pack mount (M12 × 6, Bossard B8.8, €1.20 each + weld nut in body €0.80 each + torque time 0.4 min × 6 = 2.4 min): parts €12 + labour €1.68 = €13.68. FEA-validated 4-point mount (4 × M14 B10.9, corner-only mounting, stiffness identical per NASTRAN SOL103 modal analysis, natural frequency 28 Hz maintained above 22 Hz target): 4 × €1.60 + weld nut €1.00 × 4 + torque 0.4 min × 4 = 1.6 min: parts €10.40 + labour €1.12 = €11.52. Saving: €2.16/vehicle parts, but M12→M14 heavier bolt. Include body weld nut reduction: −2 operations = €1.20/vehicle. Total saving: €3.36/vehicle. Weight: wash (2 fewer lighter bolts vs heavier bolts). Annual: €3.36 × 40k = €134k direct. Plus body manufacturing saving 2 fewer weld nuts: €580k programme (amortised) = €720k total.', submittedBy:'BEV Structural VAVE', verified:0, stars:70 },
    { id:'bev099', title:'Shear plate under battery pack deletion enabled by HPDC tray structural stiffness', system:'Pack Structural & NVH', costSavingType:'Complexity + Weight', annualSaving:'€840k', difficulty:'Medium', timeToImplement:'9–12 months', description:'Steel underbody shear plate (1.2 mm HSLA, 1,400 × 900 mm, 11.8 kg, €42/vehicle): provides underbody stiffness and pack protection. HPDC aluminium battery tray (ADC12, 4.5 mm average wall, torsional stiffness 3.2 kNm/°): equivalent underbody stiffness achieved by tray structural contribution without shear plate. FEA validated: body torsional stiffness with tray but no shear plate = 19,400 Nm/°, vs with shear plate = 19,800 Nm/°; difference 2% — within tolerance for NVH targets. Delete shear plate: −€42/vehicle, −11.8 kg. CAE NRC: €180k. Annual: €42 × 40k = €1.68M − NRC €180k = €1.5M year 1. Conservative (some stiffness risk): €840k.', submittedBy:'BEV Structural VAVE', verified:0, stars:73 },
    { id:'bev100', title:'Pack-level NVH foam deletion with structural foam encapsulation achieving same interior NVH targets', system:'Pack Structural & NVH', costSavingType:'Complexity + Weight', annualSaving:'€560k', difficulty:'Low', timeToImplement:'6–9 months', description:'Interior NVH foam on battery pack exterior top surface (closed-cell PE foam, 10 mm, 1,200 × 900 mm footprint, 0.42 kg, €5.60/vehicle): reduces 200–400 Hz structure-borne noise transmission through floor. Structural foam injected into pack frame cavities (from bev097): provides equivalent acoustic mass-spring system, −3 dB at 200 Hz achieved without surface foam. Delete surface foam: −€5.60/vehicle, −0.42 kg. No replacement cost (benefit from structural foam already in BoM as bev097). Net saving: €5.60/vehicle + weight credit €6.12 (0.42 kg × €14.58). Total: €11.72/vehicle × 40k = €468k direct. Plus 0.42 kg × €14.58 × 40k = €245k weight saving value. Total: €713k, conservative €560k.', submittedBy:'BEV Structural VAVE', verified:0, stars:70 },
  ];
...
// ─── EDU Housing, Stator, Rotor, Motor Cooling, Inverter (bev101–150) ─────────
{
  ...
  const bev101Ideas = [
    ...
    { id:'bev107', title:'Mounting bracket integration into housing wall eliminates 6 separate bracket parts per EDU', system:'EDU Housing Assembly', costSavingType:'Complexity + Weight', annualSaving:'€640k', difficulty:'Low', timeToImplement:'6–9 months', description:'Mounting brackets for EDU-to-subframe: 6 separate Al brackets (die-cast, 0.18 kg each, €4.80 each = €28.80/vehicle), each bolted to housing with 3 × M8 bolts (€3.60) = €32.40/vehicle + 12 min assembly (6 brackets × 2 min each). Mounting pad bosses integral to HPDC housing (cast features, no separate brackets): housing tooling modification €60k, zero separate parts. Saving: €32.40/vehicle parts + 12 min → 2 min (bolt to subframe only) = 10 min × €42/h = €7/vehicle labour. Total: €39.40/vehicle. Weight: −1.08 kg (6 × 0.18). NRC: housing tool modification €60k. Annual: €39.40 × 80k = €3.15M. But conservative given tooling risk and NRC: attributing €640k (net of rework risk and NRC amortised over 5yr).', submittedBy:'EDU Housing VAVE', verified:0, stars:74 },
    { id:'bev108', title:'Breather valve integration into housing vent port eliminates separate breather assembly', system:'EDU Housing Assembly', costSavingType:'Complexity', annualSaving:'€320k', difficulty:'Low', timeToImplement:'3–6 months', description:'Separate EDU breather (EMCON Technologies GPC-5, IP67 GORE vent membrane, press-fit into housing port, €3.80/vehicle, 15 g): equalises pressure during thermal cycling (−5 to +130°C = 70 kPa pressure swing), prevents oil seal blow-out. Integrated vent membrane in housing casting (HPDC port with PTFE expanded ePTFE membrane insert, Parker Hannifin Zefon VMMK, €2.40, press-fit into housing boss during machining): same function, 12 g. Saving: €1.40/vehicle. Weight: −3 g. Assembly: vent now integrated during housing machining step (0.1 min vs 0.3 min separate). Labour saving: €0.14/vehicle. Total: €1.54/vehicle × 80k = €123k + tooling saving €197k (breather housing tool eliminated) = €320k.', submittedBy:'EDU Housing VAVE', verified:1, stars:72 },
    ...
    { id:'bev110', title:'Dowel pin reduction from 8 to 4 per housing joint using precision bore datum instead', system:'EDU Housing Assembly', costSavingType:'Complexity + Labour', annualSaving:'€480k', difficulty:'Low', timeToImplement:'6–9 months', description:'Housing assembly joints (motor to gearbox flange, motor to inverter housing): 8 dowel pins per joint (2 joints × 4 pins, 6 × 12 mm steel, €0.42 each = €3.36), press-fit 0.6 min × 2 joints = 1.2 min. Precision bore datum (H7/h6 fit on 2 × 80 mm machined bores per joint, 0.01 mm tolerance): 2 dowels per joint (corner location). Same alignment accuracy achieved with 2 dowels + precision bore. Saving: 4 × €0.42 = €1.68 parts + 0.6 min × €42/h = €0.42 labour × 2 joints = €4.20/vehicle. Weight: −48 g. NRC: machining specification update, CMM measurement protocol. Annual: €4.20 × 80k = €336k + €144k quality improvement (fewer dowel installation errors) = €480k.', submittedBy:'EDU Housing VAVE', verified:1, stars:75 },
    ...
    { id:'bev112', title:'Integrated HV cable routing trunking cast into EDU housing eliminates 8 plastic cable clips', system:'EDU Housing Assembly', costSavingType:'Complexity', annualSaving:'€320k', difficulty:'Low', timeToImplement:'3–6 months', description:'HV cables from inverter to vehicle HV harness routed along EDU housing exterior, secured with 8 × plastic cable clips (€0.40 each = €3.20) + 8 × M6 clips bolts (€0.24 each = €1.92) + 1.2 min assembly = €3.20 + €1.92 + €0.84 = €5.96/vehicle. Cast routing trunking in EDU housing (4 × cast guide channels in housing exterior wall, cables snap into channels, retained by single plastic saddle cover €0.80): assembly 0.2 min. Saving: €5.96 − €0.80 − €0.14 = €5.02/vehicle. NRC: housing tool modification €40k. Annual: €5.02 × 80k = €401k − NRC €80k = €320k year 1.', submittedBy:'EDU Housing VAVE', verified:1, stars:71 },
    ...
    { id:'bev124', title:'Stator slot wedge filler material upgrade to fibre-composite, enabling 0.15 mm wall reduction', system:'Electric Motor Stator', costSavingType:'Weight', annualSaving:'€420k', difficulty:'Low', timeToImplement:'6–9 months', description:'Slot wedge (retains conductors in slot, PA66 moulded, 48 wedges/stator, 0.02 kg each = 0.96 kg, €0.18 each = €8.64/stator): wall 1.2 mm for slot mouth retention force 180 N. GF-PA66 slot wedge (40% glass-filled, same retention at 0.9 mm wall): €0.22/wedge (+€0.04 premium × 48 = €1.92/stator extra cost). Mass saving: (1.2 − 0.9) mm × 48 slots × slot area → reclaim 0.24 kg copper/stator (copper in freed slot area). Copper saving: 0.24 × €9.20 = €2.21. Net material: €2.21 − €1.92 = €0.29/stator saving. Scale: modest. Plus: thinner wedge increases slot fill by 1.5%, reducing copper weight for same resistance → composite material change catalyses re-optimisation worth €420k over programme.', submittedBy:'EDU Motor VAVE', verified:0, stars:68 },
    ...
    { id:'bev131', title:'Dynamic balance weight ring deletion via precision rotor mass balancing reduces part count', system:'EDU Housing Assembly', costSavingType:'Complexity', annualSaving:'€480k', difficulty:'Low', timeToImplement:'6–9 months', description:'Rotor dynamic balance: current process uses press-fit balance rings (Al rings at each rotor end, pre-drilled angular positions for mass removal): ring €3.80 each × 2 = €7.60/rotor + installation 2 min = €7.60 + €1.40 = €9/vehicle. Precision rotor mass balancing without rings: magnet insertion robot (bev135) places magnets to ±0.1 g positioning tolerance, stacking tolerance controlled to ±0.05 mm. Result: residual imbalance <0.5 g·cm (ISO G0.4 target 1.2 g·cm). No balance rings required. Final dynamic balance correction via small mass removal from shaft end flange (already present, drilling 2 × 3 mm holes, 0.3 min): €0.21/rotor. Saving: €9.00 − €0.21 = €8.79/rotor × 80k = €703k − NRC €220k = €480k year 1.', submittedBy:'EDU Rotor VAVE', verified:0, stars:73 },
    ...
    { id:'bev134', title:'Taper-fit shaft-to-rotor joint replaces press-fit, reducing assembly force and enabling re-use', system:'Electric Motor Rotor', costSavingType:'Quality + Lifecycle', annualSaving:'€680k', difficulty:'Medium', timeToImplement:'12–18 months', description:'Press-fit rotor-to-shaft (H7/p6, 42 mm diameter, press force 28 kN): shaft and rotor must be scrapped if wrong fit or damage. Taper fit (1:50 taper, M32 nut retention, Ringfeder 4071 locking assembly): disassemblable, rotor and shaft reusable. Press-fit: €0 hardware, 4.5 min assembly, 1.2% press-fit rejection rate (shaft/bore damage). Taper fit: €4.80 locknut, 2.5 min assembly, <0.02% rejection. Saving on rejections: 1.18% × (€124 rotor cost + €42 shaft cost) = €1.97/rotor. Labour saving: 2 min × €42/h = €1.40. Hardware cost: −€4.80. Net: €1.97 + €1.40 − €4.80 = −€1.43/rotor. But remanufacturing value (rotor recovery at EoL): €24/rotor × 0.8 recovery rate = €19.20. Total lifecycle VAVE: €19.20 − €1.43 = €17.77 × 80k = €1.42M. Half-attributed to VAVE: €680k.', submittedBy:'EDU Rotor VAVE', verified:0, stars:74 },
...
// ─── Inverter cont., Gearbox, Lubrication, EDU Thermal, Controls, HV (bev151-200) ─
{
  ...
  const bev151Ideas = [
    ...
    { id:'bev152', title:'Voltage sense PCB integration eliminates 6 separate HV voltage divider modules on inverter', system:'Inverter Assembly', costSavingType:'Complexity + Cost', annualSaving:'€480k', difficulty:'Low', timeToImplement:'6–9 months', description:'HV voltage sensing (DC bus + 3 phase outputs): 6 × Isabellenhütte VMU-D isolated voltage transducers (€6.40 each = €38.40/inverter, mounted on bracket near HV bus): HV divider + isolation amplifier in each unit. PCB-integrated capacitive-isolated voltage divider (HVPC-series, Texas Instruments AMC1311): divider network printed on HV-LV isolation boundary of inverter PCB, 6 channels, €0.64/channel = €3.84/inverter. Saving: €38.40 − €3.84 − €2.40 PCB area = €32.16/inverter × 80k = €2.57M. But isolation creepage on PCB must meet IEC 60950 (8 mm at 800V + CTI 400): dedicated HV PCB section required (€8/vehicle PCB cost increase). Net: €24.16 × 80k = €1.93M. Conservative (partial credit for unique contribution, overlaps with other PCB consolidation): €480k.', submittedBy:'Inverter VAVE', verified:0, stars:71 },
    ...
    { id:'bev156', title:'Graphene-enhanced TIM between SiC and cold plate reduces junction temperature 12°C', system:'Inverter Assembly', costSavingType:'Thermal Performance', annualSaving:'€860k', difficulty:'Medium', timeToImplement:'12–18 months', description:'Standard thermal pad between SiC module and cold plate (Bergquist GP3000, 3 W/mK, 1.5 mm, €4.80/inverter): Rth 0.5 K/W at typical contact pressure 0.2 MPa. Graphene-enhanced TIM (XG Sciences xGnP + silicone matrix, k = 12 W/mK, 0.5 mm thick, Carbice or Graphene Manufacturing Group): Rth 0.04 K/W. Junction temperature at 15 kW loss: 12°C lower. Lower junction temperature: SiC lifetime at 155°C vs 167°C → L10 life increase 4×. Inverter de-rating eliminated at high ambient (40°C): +8% continuous power available without cost. GPTIM cost: €12/inverter vs €4.80 = +€7.20. Benefit: warranty improvement 0.3% × €2,400 = €7.20/vehicle × 80k = €576k. De-rating elimination value: €284k. Cost premium fleet: −€576k. Net: €576k + €284k − €576k = €284k direct + €576k warranty = €860k.', submittedBy:'Inverter VAVE', verified:0, stars:73 },
    ...
    { id:'bev160', title:'PWM frequency increase to 20 kHz enables EMI filter size reduction, saving 0.28 kg weight', system:'Inverter Assembly', costSavingType:'Weight + Size', annualSaving:'€420k', difficulty:'Low', timeToImplement:'6–9 months', description:'SiC switching at 10 kHz: EMI filter cut-off 8 kHz, requires L = 180 µH, C = 22 µF (TDK B82477, 0.42 kg, €24/vehicle). At 20 kHz switching: filter cut-off 16 kHz, L = 68 µH, C = 8.2 µF (TDK B82477 smaller, 0.14 kg, €12/vehicle). Saving: €12/vehicle + 0.28 kg. SiC switching at 20 kHz: switching loss increase 8 W (SiC low switching loss advantage). Energy: +8 W × 8,000 h lifecycle × €0.18 = €11.52 lifetime. Weight: 0.28 kg × €14.58 = €4.08 credit/vehicle. Net: €12 − €11.52 lifetime/10yr = €12 − €1.15/yr + €4.08 weight = €14.93/vehicle × 80k = €1.19M. Less NRC EMC retest: €280k. Net: €912k. Conservative: €420k (some switching loss increase risk).', submittedBy:'Inverter VAVE', verified:0, stars:70 },
    { id:'bev161', title:'Six-phase motor and split-inverter topology reduces per-switch current 50%, enabling lower-rated devices', system:'Inverter Assembly', costSavingType:'Cost + Reliability', annualSaving:'€1.8M', difficulty:'High', timeToImplement:'24–36 months', description:'Three-phase 200 kW motor at 800V: phase current 160A RMS → 12 × 1,200V/300A SiC devices per inverter (€8.40 × 12 = €100.80). Six-phase motor (dual 3-phase winding, 30° phase shift): each 3-phase half-inverter carries 80A RMS → 12 × 1,200V/150A SiC (cheaper die: €4.80 × 24 = €115.20). Apparent cost increase, but reliability: fault-tolerant (one phase group fails → run at 50% power), enabling 3rd-life operation. Maintenance avoidance: 0.6% total inverter failure × 50% would become recoverable → €2,400 × 0.6% × 0.5 = €7.20/vehicle warranty saving × 80k = €576k. Motor: 6-phase winding saves 12% copper (bev113/114 synergy). Net SiC cost: +€14.40/vehicle. Net positive: €576k − €1.15M SiC premium + €2.38M copper saving synergy = €1.8M. BMW e-tron 2025 and Renault 2027 roadmap six-phase.', submittedBy:'Inverter VAVE', verified:0, stars:75 },
    ...
    { id:'bev170', title:'Common differential across front and rear axle gearboxes reduces differential SKUs from 4 to 1', system:'Gearbox & Reduction Drive', costSavingType:'Platform Commonisation', annualSaving:'€1.6M', difficulty:'High', timeToImplement:'18–24 months', description:'4 different open differentials across platform variants (front, rear, performance front, performance rear — different torque ratings and shaft angles). Common limited-slip differential (Torsen Type-B helical LSD, 480 Nm input rating: exceeds all applications with margin, €68/differential vs open differential €28): LSD premium €40/vehicle. Platform saving: 3 differential tool sets eliminated: 3 × €240k = €720k. Annual: supply chain consolidation: €1.28M. LSD gives torque vectoring benefit vs open differential: reduces understeer, improves traction (value to customer). LSD premium −€40 × 80k = −€3.2M cost/yr vs open. Net annual: −€3.2M + €1.28M + €720k amortised = −€1.2M (negative). However, LSD enables deletion of electronic torque vectoring system (€140/vehicle): +€11.2M. Total positive: €9.5M. Conservative unique VAVE: €1.6M (differential tooling only, excluding torque vectoring system interaction).', submittedBy:'Gearbox VAVE', verified:0, stars:70 },
    { id:'bev171', title:'Angular contact bearing deletion — deep groove bearing with preload replaces dual angular contact pair', system:'Gearbox & Reduction Drive', costSavingType:'Cost', annualSaving:'€640k', difficulty:'Low', timeToImplement:'6–9 months', description:'Output shaft bearing: 2 × angular contact ball bearings (SKF 7207, €12.40 each = €24.80/vehicle): provides axial load capacity for helical gear thrust. Single deep groove ball bearing (SKF 6207/C2, preloaded with wave spring, €8.20 + €1.40 spring = €9.60): radial and axial stiffness achieved by preload (spring force 240 N). Helical gear axial thrust at max torque: 1.8 kN (verified by FEA). Deep groove axial capacity at 240 N preload: 2.4 kN (33% margin). Saving: €24.80 − €9.60 = €15.20/vehicle × 80k = €1.22M. Weight: −0.18 kg. NRC: bearing selection validation, driveline NVH test €100k. Net year 1: €1.12M. Conservative (some axial load uncertainty): €640k.', submittedBy:'Gearbox VAVE', verified:0, stars:72 },
    { id:'bev172', title:'Dog clutch park engagement mechanism replaces separate park pawl assembly', system:'Gearbox & Reduction Drive', costSavingType:'Complexity + Weight', annualSaving:'€480k', difficulty:'Medium', timeToImplement:'12–18 months', description:'Separate park pawl (cast steel, pawl spring, roller, actuator solenoid, €28/vehicle, 0.44 kg): standard parking lock. Dog clutch park (rotating dog on output shaft engages fixed dog on housing via solenoid, same as gear engagement but for park position): no separate pawl assembly. Dog clutch: €12/vehicle (already partial of geartrain). Park engagement force: solenoid 80 N × 4:1 lever = 320 N engagement force (exceeds hill-hold 240 N requirement on 30% slope). Saving: €28 − €12 incremental = €16/vehicle. Weight: −0.44 kg. NRC: dog clutch geometry validation, acoustic test (click engagement OK for park) €120k. Annual: €16 × 80k = €1.28M − NRC €800k amortised = €480k.', submittedBy:'Gearbox VAVE', verified:0, stars:71 },
    { id:'bev173', title:'Planet carrier integration into gearbox housing wall eliminates separate carrier casting', system:'Gearbox & Reduction Drive', costSavingType:'Complexity + Weight', annualSaving:'€560k', difficulty:'Medium', timeToImplement:'12–18 months', description:'Planetary gearbox (2-stage, some EDU designs): planet carrier (cast nodular iron, €28/vehicle, 1.2 kg): separate from housing, pilot-bore fitted. Integrated planet carrier (cast integrally with HPDC Al housing end face, Al alloy Silafont-36, carrier arms machined from housing face — reducing separate iron casting): housing cost increase €18, iron casting eliminated €28. Net: €10/vehicle saving. Weight: +0.9 kg (Al carrier heavier than Fe carrier for same stiffness — this idea is marginal). Better for simpler one-stage reducers. Valid when carrier is simple (3-pin design): save on carrier casting + assembly. Annual: €10 × 80k = €800k − NRC €240k = €560k.', submittedBy:'Gearbox VAVE', verified:0, stars:68 },
    ...
    { id:'bev176', title:'Oil level sensor deletion — oil volume controlled by sealed fill-for-life procedure with dipstick delete', system:'Gearbox & Reduction Drive', costSavingType:'Complexity', annualSaving:'€280k', difficulty:'Low', timeToImplement:'3–6 months', description:'Oil level sensor (BT Inductive, €4.20/vehicle): detects oil loss. Fill-for-life sealed gearbox (no drain/fill service requirement, volume controlled at assembly via precision pump fill, ±5 mL accuracy, ISOFLEX NBU15 or fluid-for-life ATF): oil volume guaranteed by assembly process control (Cpk >1.67 on fill volume). Oil level monitoring: indirect (thermal model monitors gearbox temperature — oil loss detected as anomalous ΔT rise: >15°C above model = BMS warning). Oil level sensor deleted: €4.20/vehicle × 80k = €336k. False warning elimination (oil sensor contamination-induced false positives: 0.3% × €240 dealer visit = €0.72/vehicle): warranty saving €57.6k. Total: €393k ≈ €280k (conservative for oil-loss detection risk).', submittedBy:'Gearbox VAVE', verified:0, stars:69 },
    ...
    { id:'bev183', title:'ATF cooler bypass thermostat deletion — thermal model shows unnecessary in sealed fill-for-life EDU', system:'EDU Lubrication', costSavingType:'Complexity', annualSaving:'€480k', difficulty:'Low', timeToImplement:'6–9 months', description:'ATF cooler bypass thermostat (wax-element, opens at 80°C, €8.40/vehicle, 0.12 kg): allows ATF warm-up before cooler engagement (improves cold-weather efficiency). Thermal model (GT-COOL): ATF reaches 80°C in 4.2 min at −7°C ambient with no thermostat — within acceptable warm-up window. Delete thermostat: ATF flows through cooler from cold start (cooler is actually a heater at −7°C — coolant loop at 40°C warms ATF). Thermostat delete: −€8.40/vehicle × 80k = €672k. Cold-weather efficiency: neutral (cooler acts as heater below 40°C coolant). Warm-up time: 3.8 min vs 4.2 min (faster — cooler preheats). NRC: thermal validation €180k. Year 1: €492k. Ongoing: €672k ≈ €480k (conservative).', submittedBy:'EDU Lubrication VAVE', verified:0, stars:70 },
    { id:'bev184', title:'Oil reservoir integration into gearbox casting cavity eliminates separate expansion tank', system:'EDU Lubrication', costSavingType:'Complexity + Weight', annualSaving:'€320k', difficulty:'Low', timeToImplement:'3–6 months', description:'Separate oil expansion reservoir (€6.80/vehicle, 0.18 kg, 150 mL, HDPE, mounted on housing via bracket): accommodates thermal volume expansion of ATF (10% from −40 to +130°C). Integrated expansion cavity in gearbox housing HPDC (10% headspace above nominal fill, no separate reservoir): housing tool modification €32k. Saving: €6.80 + €1.20 bracket + €0.40 assembly = €8.40/vehicle × 80k = €672k − NRC €32k = €640k. But: integrated headspace reduces HPDC yield vs solid section (porosity risk in thin-wall cavity). Risk: 5% rework rate on first 10k parts. Conservative: €320k net.', submittedBy:'EDU Lubrication VAVE', verified:0, stars:69 },
    { id:'bev185', title:'Debris sensor deletion — magnetic drain plug provides adequate contamination monitoring at EOL', system:'EDU Lubrication', costSavingType:'Complexity', annualSaving:'€480k', difficulty:'Low', timeToImplement:'3–6 months', description:'In-line oil debris sensor (Parker Kittiwake MADD-SENSOR, €12.40/vehicle, detects ferrous particles >50 µm): provides real-time gearbox wear monitoring. Analysis: sealed fill-for-life gearbox (no drain service) — sensor data not actioned between service intervals. Monitoring replaced by: magnetic drain plug inspection at EOL check (200,000 km) or if BMS gear temperature anomaly flagged. Delete debris sensor: −€12.40 + €2.40 harness + €0.80 connector = €15.60/vehicle × 80k = €1.25M. Risk: catastrophic gear failure pre-warning lost (0.08% fleet × €4,800 gearbox replacement = €3.84/vehicle × 80k = €307k). Net: €1.25M − €307k = €943k. Conservative (acknowledging IoT value of data): €480k.', submittedBy:'EDU Lubrication VAVE', verified:0, stars:68 },
    ...
    { id:'bev190', title:'Coolant temperature sensor standardisation to 2 NTCs eliminates 4 redundant sensors on EDU circuit', system:'EDU Thermal Management', costSavingType:'Complexity', annualSaving:'€480k', difficulty:'Low', timeToImplement:'3–6 months', description:'EDU coolant circuit: 6 NTC sensors (EDU inlet, EDU outlet, motor mid-point, inverter outlet, coolant manifold, reservoir): €3.80 × 6 = €22.80/vehicle. CFD validated 2-sensor placement (EDU inlet + outlet only): BMS uses transfer function to estimate internal temperatures ±3°C (accuracy confirmed against 6-sensor baseline on 48-thermocouple dyno fixture). Delete 4 sensors: €15.20/vehicle + 4 × €2.40 harness = €24.80/vehicle. BMS algorithm NRC: €40k. Annual: €24.80 × 80k = €1.98M − NRC €40k = €1.94M. Conservative (some thermal model inaccuracy risk at extreme conditions): €480k (unique contribution after bev056 battery thermal already captured).', submittedBy:'EDU Thermal VAVE', verified:0, stars:71 },
    { id:'bev191', title:'ATF-to-coolant heat exchanger deletion using thermal model to confirm gearbox self-cool capability', system:'EDU Thermal Management', costSavingType:'Complexity + Cost', annualSaving:'€960k', difficulty:'Medium', timeToImplement:'12–18 months', description:'ATF-to-coolant heat exchanger (Behr ATC-30, €24/vehicle, 0.38 kg): cools gearbox oil via coolant loop. Thermal model: peak ATF temperature (WLTP H + max trailer) = 128°C without HX (gearbox housing natural convection rated at 4 kW). HX adds: 2 kW additional cooling, reducing peak to 118°C. Fluid-for-life ATF rated to 150°C (per bev182/169): 128°C fully within limit even without HX. Delete HX: €24 + €4.80 fittings + €6 lines + 0.8 min assembly = €35.36/vehicle × 80k = €2.83M. NRC: thermal validation: €480k. Torque limit at high ATF temperature (BMS software): €40k. Year 1 net: €2.31M. Conservative: €960k (some edge cases at 45°C ambient + max load + hot soak).', submittedBy:'EDU Thermal VAVE', verified:0, stars:73 },
