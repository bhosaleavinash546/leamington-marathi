...
export const DEFAULT_RATE_LIBRARY: RateLibrary = {
  ...
  materials: [
    ...
    { id: 'mat-hsno-rotor-700', grade: 'High-Strength NO Electrical (~700 MPa, 0.30mm rotor)', category: 'Electrical Steel Sheet', pricePerKg: 2.60, scrapRecoveryPricePerKg: 0.28, densityKgPerM3: 7650, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK electrical steel Jul 2026. High-yield thin-gauge NO for high-speed EV traction rotors (bridge stresses at 15–20k rpm) — BYD/Xiaomi-class hyper-motors. Higher Si+alloy, harder to notch.', confidence: 'Low' },
    { id: 'mat-hsno-rotor-960', grade: 'Ultra-High-Strength NO Electrical (~960 MPa, 0.20–0.27mm rotor)', category: 'Electrical Steel Sheet', pricePerKg: 3.20, scrapRecoveryPricePerKg: 0.30, densityKgPerM3: 7600, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK electrical steel Jul 2026. Ultra-high-yield thin NO for >20k rpm rotors (Xiaomi HyperEngine V8s ~27,200 rpm class) — enables slim bridges + high tip speed. Premium, heavy notch-tool wear.', confidence: 'Low' },
    // ── Flagship high-speed EV rotor / high-frequency laminations (SU7 Ultra, Yangwang U7/U8/U9) ──
    { id: 'mat-no15-15a', grade: 'NO15 Ultra-Thin NO Electrical (0.15mm)', category: 'Electrical Steel Sheet', pricePerKg: 3.90, scrapRecoveryPricePerKg: 0.30, densityKgPerM3: 7600, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK electrical steel Jul 2026. 0.15mm ultra-thin NO — very high-frequency traction (SU7 Ultra V8s / high-speed EV); low eddy loss, low stacking factor, hard to blank (fine burr control). Bonded (backlack) stacks typical.', confidence: 'Low' },
    { id: 'mat-no10-10a', grade: 'NO10 Ultra-Thin NO Electrical (0.10mm)', category: 'Electrical Steel Sheet', pricePerKg: 5.50, scrapRecoveryPricePerKg: 0.35, densityKgPerM3: 7600, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK electrical steel Jul 2026. 0.10mm foil-gauge NO — extreme high-speed / high-frequency rotors (aero/hypercar & top-end EV traction). Lowest iron loss; etched/bonded rather than hard-die blanked at volume.', confidence: 'Low' },
    { id: 'mat-si65-jnex-10', grade: '6.5% Si High-Frequency Electrical (JNEX/Super-Core class, 0.10mm)', category: 'Electrical Steel Sheet', pricePerKg: 6.80, scrapRecoveryPricePerKg: 0.35, densityKgPerM3: 7490, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK speciality Jul 2026. 6.5% silicon steel (JFE JNEX / Super-Core class) — near-zero magnetostriction, lowest high-frequency core loss for high-rpm/high-pole EV & aerospace motors, reactors. Brittle, specialised processing.', confidence: 'Low' },
    { id: 'mat-uhsno-1100', grade: 'Ultra-High-Strength NO Electrical (~1100 MPa, 30k-rpm rotor)', category: 'Electrical Steel Sheet', pricePerKg: 3.60, scrapRecoveryPricePerKg: 0.32, densityKgPerM3: 7600, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK electrical steel Jul 2026. ~1100 MPa yield thin-gauge NO for ~30,000 rpm flagship rotors (BYD Yangwang U7/U8/U9 quad-motor, Xiaomi flagship) — holds slim bridges at extreme tip speed. Premium alloy, severe notch-tool wear.', confidence: 'Low' },
    { id: 'mat-cofe-thin-010', grade: 'Cobalt-Iron Thin-Gauge (0.10mm, Vacoflux/Hiperco)', category: 'Electrical Steel Sheet', pricePerKg: 72.00, scrapRecoveryPricePerKg: 4.50, densityKgPerM3: 8120, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK speciality Jul 2026. 0.10mm cobalt-iron (49Co-2V) — highest saturation (2.3T) + high-frequency capability for maximum power-density motors (aerospace, hypercar/flagship EV traction); H₂ final anneal, very expensive.', confidence: 'Low' },
    // ── EV motor winding conductor (hairpin) ──
    { id: 'mat-cu-hairpin', grade: 'Rectangular Enamelled Hairpin Copper (winding)', category: 'Winding Copper (Hairpin)', pricePerKg: 13.20, scrapRecoveryPricePerKg: 6.00, densityKgPerM3: 8930, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK Jul 2026. Flat enamelled (grade-2/corona-resistant) rectangular copper wire for hairpin/bar-wound EV traction stators — stamped/bent hairpins, laser-welded crowns. ETP + enamel + forming premium over C110.', confidence: 'Low' },
    { id: 'mat-al-hairpin', grade: 'Rectangular Enamelled Hairpin Aluminium (winding)', category: 'Winding Aluminium (Hairpin)', pricePerKg: 4.80, scrapRecoveryPricePerKg: 1.10, densityKgPerM3: 2700, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK Jul 2026. Flat enamelled aluminium hairpin conductor — cost/weight-down alternative to copper in some EV traction motors; lower conductivity, larger slot fill.', confidence: 'Low' },
    { id: 'mat-al-busbar', grade: 'Aluminium Busbar (EV / battery)', category: 'Aluminium Sheet', pricePerKg: 3.80, scrapRecoveryPricePerKg: 1.00, densityKgPerM3: 2700, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK Jul 2026. 1050/6101 aluminium busbar stock — battery-pack and inverter interconnects, cell-to-body (CTB/CTC) module bars; lighter/cheaper than copper, larger cross-section.', confidence: 'Low' },
    // ── Spring steel strip ──
    ...
    { id: 'mat-htf-gigacast', grade: 'Heat-Treat-Free Giga-Casting Alloy (Xiaomi Titan / Tesla-class)', category: 'Structural HPDC Aluminium', pricePerKg: 3.35, scrapRecoveryPricePerKg: 0.60, densityKgPerM3: 2680, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07 (see CASTING PRICING BASIS). Self-developed heat-treat-free AlSi(Mn)Mg family for single-piece rear/front-underbody megacastings on 6,000–9,000T+ giga-presses (Xiaomi "Titan Metal", Tesla HTF, BYD). As-cast ductility, no distortion-prone T7; represents the OEM self-alloyed class — override price with the actual supply quote.', confidence: 'Low' },
    ...
    { id: 'mat-pe100-pipe', grade: 'PE100 Pipe Grade (black, PE4710)', category: 'Extrusion', pricePerKg: 1.35, scrapRecoveryPricePerKg: 0.12, densityKgPerM3: 960, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK pipe-resin benchmark 2026-07. High-MW bimodal HDPE — pressure water/gas pipe (PE4710). Die swell ~15%.', confidence: 'Medium' },
    { id: 'mat-pe80-pipe', grade: 'PE80 Pipe Grade', category: 'Extrusion', pricePerKg: 1.28, scrapRecoveryPricePerKg: 0.12, densityKgPerM3: 950, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK pipe-resin benchmark 2026-07. Medium-density pipe grade — gas/drainage pipe.', confidence: 'Medium' },
    { id: 'mat-upvc-pipe', grade: 'uPVC Pipe Compound (K67, dry-blend)', category: 'Extrusion', pricePerKg: 0.90, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1420, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK PVC compounder 2026-07. Rigid PVC-U pressure/soil pipe compound (Ca-Zn stabilised). Low die swell ~5%. Heat-sensitive — limits output.', confidence: 'Medium' },
    { id: 'mat-pvc-cable', grade: 'PVC Cable Compound (flexible, insulation)', category: 'Extrusion', pricePerKg: 1.35, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1350, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK cable-compound benchmark 2026-07. Plasticised PVC insulation/sheathing — building wire, flex cords.', confidence: 'Medium' },
    { id: 'mat-xlpe-cable', grade: 'XLPE Cable Insulation Compound', category: 'Extrusion', pricePerKg: 2.10, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 925, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK cable-compound benchmark 2026-07. Crosslinkable PE (peroxide/silane) — MV/HV cable insulation. Cured, non-recyclable scrap.', confidence: 'Low' },
    { id: 'mat-gpps-ext', grade: 'GPPS Extrusion Sheet Grade', category: 'Extrusion', pricePerKg: 1.30, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1050, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK resin distributor 2026-07. General-purpose PS — clear thermoforming/sign sheet. Low die swell.', confidence: 'Medium' },
    { id: 'mat-abs-ext-sheet', grade: 'ABS Extrusion Sheet Grade', category: 'Extrusion', pricePerKg: 1.85, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 1050, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK resin distributor 2026-07. Extrusion ABS — automotive/appliance thermoforming sheet, capstock.', confidence: 'Medium' },
    { id: 'mat-pmma-ext-sheet', grade: 'PMMA Extrusion Sheet (acrylic)', category: 'Extrusion', pricePerKg: 2.60, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1190, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK resin distributor 2026-07. Extruded acrylic sheet — glazing, signage, light guides. Low die swell.', confidence: 'Low' },
    { id: 'mat-pc-ext-sheet', grade: 'PC Extrusion/Solid Sheet Grade', category: 'Extrusion', pricePerKg: 3.20, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1200, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK resin distributor 2026-07. Extruded polycarbonate solid/multiwall sheet — glazing, machine guards. High melt temp → high energy.', confidence: 'Low' },
    { id: 'mat-pvc-medical-tube', grade: 'Medical PVC Tubing Compound (DEHP-free)', category: 'Extrusion', pricePerKg: 1.95, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1250, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK medical-compound benchmark 2026-07. Non-phthalate plasticised PVC — IV/medical tubing, ISO 10993.', confidence: 'Low' },
    { id: 'mat-tpu-medical-tube', grade: 'Medical TPU Tubing (85A)', category: 'Extrusion', pricePerKg: 6.50, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1150, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK medical-compound benchmark 2026-07. Aliphatic/aromatic TPU — catheters, medical tube; biocompatible.', confidence: 'Low' },
    { id: 'mat-tpe-profile', grade: 'TPE-S Extrusion Profile (60 Shore A)', category: 'Extrusion', pricePerKg: 2.40, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 940, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK resin distributor 2026-07. Styrenic TPE — soft-touch seals, glazing gaskets (recyclable EPDM alternative). Die swell ~10%.', confidence: 'Low' },
    { id: 'mat-pvc-foam', grade: 'Rigid PVC Foam (Celuka) Profile', category: 'Extrusion', pricePerKg: 1.15, scrapRecoveryPricePerKg: 0.03, densityKgPerM3: 700, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK PVC compounder 2026-07. Free-foam/Celuka rigid PVC — trim board, cladding, furniture profile. Low bulk density.', confidence: 'Low' },
    { id: 'mat-pp-ext-sheet', grade: 'PP Extrusion Sheet Grade', category: 'Extrusion', pricePerKg: 1.15, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 905, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK resin distributor 2026-07. High-melt-strength PP — thermoforming/packaging sheet, corrugated board.', confidence: 'Medium' },
    { id: 'mat-pa12-ext-tube', grade: 'PA12 Extrusion (fuel/brake line tube)', category: 'Extrusion', pricePerKg: 6.20, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 1010, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK speciality resin 2026-07. Nylon 12 — automotive fuel/brake/air-brake tube, multi-layer barrier line.', confidence: 'Low' },
    // ── Additives / Masterbatch (let-down adders — see extrusion additive input) ─
    { id: 'mat-mb-colour', grade: 'Colour Masterbatch (universal)', category: 'Additive / Masterbatch', pricePerKg: 4.50, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1200, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK MB supplier 2026-07. Universal colour concentrate; let-down ~2–4%.', confidence: 'Medium' },
    { id: 'mat-mb-white-tio2', grade: 'White Masterbatch (70% TiO₂)', category: 'Additive / Masterbatch', pricePerKg: 3.20, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1600, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK MB supplier 2026-07. High-TiO₂ white; let-down ~3–6%.', confidence: 'Medium' },
    { id: 'mat-mb-black', grade: 'Black Masterbatch (40% carbon)', category: 'Additive / Masterbatch', pricePerKg: 2.10, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1150, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK MB supplier 2026-07. Carbon-black concentrate (also UV shield); let-down ~2–3%.', confidence: 'Medium' },
    { id: 'mat-add-uv', grade: 'UV Stabiliser Masterbatch (HALS)', category: 'Additive / Masterbatch', pricePerKg: 6.80, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1000, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK additive supplier 2026-07. HALS/UV-absorber concentrate for outdoor profiles/pipe; let-down ~1–3%.', confidence: 'Low' },
    { id: 'mat-add-antistat', grade: 'Anti-Static Additive Masterbatch', category: 'Additive / Masterbatch', pricePerKg: 5.50, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1000, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK additive supplier 2026-07. Migratory/permanent anti-stat; let-down ~1–2%.', confidence: 'Low' },
    { id: 'mat-add-fr', grade: 'Flame-Retardant Masterbatch (halogen-free)', category: 'Additive / Masterbatch', pricePerKg: 4.20, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1300, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK additive supplier 2026-07. Non-halogen FR for cable/profile; high let-down ~10–25% (property-driven).', confidence: 'Low' },
    { id: 'mat-add-impact', grade: 'Impact Modifier (acrylic/CPE)', category: 'Additive / Masterbatch', pricePerKg: 3.10, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1000, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK additive supplier 2026-07. Impact modifier for rigid PVC/PP; let-down ~4–8%.', confidence: 'Low' },
    { id: 'mat-add-procaid', grade: 'Processing Aid (fluoropolymer PPA)', category: 'Additive / Masterbatch', pricePerKg: 8.50, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1000, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK additive supplier 2026-07. Fluoropolymer PPA — eliminates melt fracture, boosts output; let-down ~0.05–0.1%.', confidence: 'Low' },
    // ── Thermoforming Sheet (gauge stock; regrind recovery = trimmed skeleton value) ─
    // Commodity thermoplastics
    { id: 'mat-hips-tf', grade: 'HIPS Thermoforming Sheet', category: 'Thermoforming Sheet', pricePerKg: 1.05, scrapRecoveryPricePerKg: 0.30, densityKgPerM3: 1040, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. High-impact PS gauge sheet — cups, trays, signage, refrigerator liners. Wide forming window; skeleton fully regrindable.', confidence: 'Medium' },
    { id: 'mat-abs-tf', grade: 'ABS Thermoforming Sheet', category: 'Thermoforming Sheet', pricePerKg: 2.00, scrapRecoveryPricePerKg: 0.45, densityKgPerM3: 1050, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Automotive/appliance ABS gauge sheet — interior trim, cargo liners, luggage; SPI texture capable.', confidence: 'Medium' },
    { id: 'mat-petg-tf', grade: 'PETG Thermoforming Sheet (clear)', category: 'Thermoforming Sheet', pricePerKg: 1.85, scrapRecoveryPricePerKg: 0.45, densityKgPerM3: 1270, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Glycol-modified PET — clear packaging, medical trays, retail; easy deep draw, no pre-dry.', confidence: 'Medium' },
    { id: 'mat-apet-tf', grade: 'APET Sheet (amorphous, food pack)', category: 'Thermoforming Sheet', pricePerKg: 1.55, scrapRecoveryPricePerKg: 0.40, densityKgPerM3: 1340, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Amorphous PET — clear food trays/clamshells, blister; highest-volume packaging sheet. rPET content common.', confidence: 'Medium' },
    { id: 'mat-cpet-tf', grade: 'CPET Sheet (crystalline, dual-ovenable)', category: 'Thermoforming Sheet', pricePerKg: 1.75, scrapRecoveryPricePerKg: 0.35, densityKgPerM3: 1400, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Crystallising PET — dual-ovenable ready-meal trays (-40 to +220°C); needs hot tool + long crystallisation cycle.', confidence: 'Low' },
    { id: 'mat-rpvc-tf', grade: 'Rigid PVC Thermoforming Sheet', category: 'Thermoforming Sheet', pricePerKg: 1.35, scrapRecoveryPricePerKg: 0.20, densityKgPerM3: 1400, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Rigid PVC gauge sheet — blister packs, ID/credit cards, medical; low forming temp, heat-sensitive.', confidence: 'Medium' },
    { id: 'mat-pp-tf', grade: 'PP Thermoforming Sheet (HMS)', category: 'Thermoforming Sheet', pricePerKg: 1.30, scrapRecoveryPricePerKg: 0.30, densityKgPerM3: 905, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. High-melt-strength PP — hot-fill cups, deli tubs, medical; narrow window, needs sag control. Lightest sheet.', confidence: 'Medium' },
    { id: 'mat-hdpe-tf', grade: 'HDPE Thermoforming Sheet', category: 'Thermoforming Sheet', pricePerKg: 1.25, scrapRecoveryPricePerKg: 0.35, densityKgPerM3: 950, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. HDPE gauge sheet — industrial trays, liners, kayaks (heavy-gauge); heavy sag, low melt strength.', confidence: 'Low' },
    { id: 'mat-ldpe-tf', grade: 'LDPE Thermoforming Sheet', category: 'Thermoforming Sheet', pricePerKg: 1.30, scrapRecoveryPricePerKg: 0.30, densityKgPerM3: 925, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. LDPE gauge sheet — soft protective trays, flexible packaging inserts. Very low melt strength.', confidence: 'Low' },
    { id: 'mat-ps-foam-tf', grade: 'PS Foam Sheet (foamed tray stock)', category: 'Thermoforming Sheet', pricePerKg: 1.60, scrapRecoveryPricePerKg: 0.15, densityKgPerM3: 120, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Expanded PS foam sheet — egg cartons, meat/produce trays, insulation; low density, high stiffness-per-kg.', confidence: 'Low' },
    // Engineering & high-performance thermoplastics
    { id: 'mat-pmma-tf', grade: 'PMMA / Acrylic Sheet (cast/extruded)', category: 'Thermoforming Sheet', pricePerKg: 2.90, scrapRecoveryPricePerKg: 0.35, densityKgPerM3: 1190, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet distributor 2026-07. Acrylic sheet — baths/spas, skylights, lightboxes, displays; excellent clarity, low sag (high melt strength).', confidence: 'Low' },
    { id: 'mat-pc-tf', grade: 'PC Thermoforming Sheet', category: 'Thermoforming Sheet', pricePerKg: 3.40, scrapRecoveryPricePerKg: 0.35, densityKgPerM3: 1200, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet distributor 2026-07. Polycarbonate sheet — machine guards, glazing, riot shields, aircraft interiors; high forming temp → high oven energy, must pre-dry.', confidence: 'Low' },
    { id: 'mat-pei-tf', grade: 'PEI (Ultem) Sheet (aerospace)', category: 'Thermoforming Sheet', pricePerKg: 28.00, scrapRecoveryPricePerKg: 1.00, densityKgPerM3: 1270, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK speciality 2026-07. Polyetherimide sheet — aircraft interior panels/ducting (FST/OSU compliant); very high forming temp ~250°C.', confidence: 'Low' },
    { id: 'mat-pps-tf', grade: 'PPS Sheet (high-temp)', category: 'Thermoforming Sheet', pricePerKg: 14.00, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 1350, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK speciality 2026-07. Polyphenylene sulphide sheet — chemical/high-temp trays, under-bonnet; ~285°C forming, semi-crystalline.', confidence: 'Low' },
    // Multi-layer / co-extruded sheets
    { id: 'mat-abs-pmma-tf', grade: 'ABS/PMMA Co-ex Sheet (capped)', category: 'Thermoforming Sheet', pricePerKg: 2.60, scrapRecoveryPricePerKg: 0.15, densityKgPerM3: 1080, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. ABS substrate + acrylic cap — sanitaryware, caravan/RV panels, spas; UV/scratch cap. Multilayer regrind limited.', confidence: 'Low' },
    { id: 'mat-abs-pc-tf', grade: 'ABS/PC Co-ex Sheet', category: 'Thermoforming Sheet', pricePerKg: 3.10, scrapRecoveryPricePerKg: 0.15, densityKgPerM3: 1130, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. PC/ABS blend/co-ex — automotive exterior, luggage, high-impact housings; higher forming temp than ABS.', confidence: 'Low' },
    { id: 'mat-pp-tpo-tf', grade: 'PP/TPO Automotive Sheet', category: 'Thermoforming Sheet', pricePerKg: 1.90, scrapRecoveryPricePerKg: 0.20, densityKgPerM3: 900, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. TPO-skinned PP — automotive interior skins, load floors, underbody shields; soft-touch grain, recyclable.', confidence: 'Low' },
    { id: 'mat-petg-barrier-tf', grade: 'PETG/EVOH Barrier Sheet', category: 'Thermoforming Sheet', pricePerKg: 2.40, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 1300, region: 'UK', effectiveDate: '2026-07', sourceNote: 'UK sheet extruder 2026-07. Multilayer PET/EVOH/tie barrier — MAP food trays, extended shelf-life; EVOH barrier core. Regrind cross-contamination limits recovery.', confidence: 'Low' },
    ...
    { id: 'mat-br', grade: 'BR Polybutadiene (high-cis) 60 Shore A', category: 'Rubber', pricePerKg: 1.75, scrapRecoveryPricePerKg: 0.04, densityKgPerM3: 1000, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. High-cis polybutadiene — blended with NR/SBR for abrasion resistance & low rolling resistance; tyres, anti-vibration, rollers. Shore 60A.', confidence: 'Medium' },
    { id: 'mat-bromobutyl', grade: 'Bromobutyl (BIIR) 50 Shore A', category: 'Rubber', pricePerKg: 2.85, scrapRecoveryPricePerKg: 0.04, densityKgPerM3: 930, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. Brominated butyl — tyre inner liners, pharma closures/stoppers, curing bladders; low permeability + faster cure than plain IIR. Shore 50A.', confidence: 'Low' },
    { id: 'mat-chlorobutyl', grade: 'Chlorobutyl (CIIR) 55 Shore A', category: 'Rubber', pricePerKg: 2.75, scrapRecoveryPricePerKg: 0.04, densityKgPerM3: 930, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. Chlorinated butyl — tyre inner liners, pharma stoppers, heat-resistant seals; co-vulcanisable with diene rubbers. Shore 55A.', confidence: 'Low' },
    { id: 'mat-ffkm', grade: 'FFKM Perfluoroelastomer (Kalrez-type) 75 Shore A', category: 'Rubber', pricePerKg: 320.00, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 2010, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. Perfluoroelastomer — extreme chemical + >300°C seals for semicon, aerospace, oil&gas; the highest-cost elastomer, tiny O-rings. Shore 75A.', confidence: 'Low' },
    { id: 'mat-nbr-high-acn', grade: 'NBR High-ACN (fuel) 75 Shore A', category: 'Rubber', pricePerKg: 2.55, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1250, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. High-acrylonitrile nitrile — maximum fuel/oil resistance for fuel hoses, gaskets; stiffer, worse low-temp than standard NBR. Shore 75A.', confidence: 'Low' },
    { id: 'mat-epdm-peroxide', grade: 'EPDM Peroxide-Cured 70 Shore A', category: 'Rubber', pricePerKg: 2.15, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1150, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. Peroxide-cured EPDM — better heat-ageing & compression set than sulphur-cured; coolant/steam seals, under-bonnet. Shore 70A.', confidence: 'Low' },
    { id: 'mat-silicone-medical', grade: 'LSR Medical-Grade 30 Shore A', category: 'Rubber', pricePerKg: 16.50, scrapRecoveryPricePerKg: 0.00, densityKgPerM3: 1120, region: 'UK', effectiveDate: '2026-07', sourceNote: 'Index-anchored 2026-07. USP Class VI / ISO 10993 liquid silicone — medical seals, valves, baby/health products; biocompatible, premium over industrial LSR. Shore 30A.', confidence: 'Low' },
  ...
  machines: [
    ...
    makeMachine('hpdc-giga-6100t', 'Giga-Casting Press 6100T (megacasting)',
      { annualDepreciation: 520000, maintenance: 240000, energy: 320000, floorSpace: 120000, indirectSupport: 90000, financeCost: 65000, annualAvailableHours: 4000, machineUtilization: 0.80 },
    ...
    makeMachine('hpdc-giga-9000t', 'Giga-Casting Press 9000T (Xiaomi/Tesla-class)',
      { annualDepreciation: 780000, maintenance: 360000, energy: 480000, floorSpace: 180000, indirectSupport: 140000, financeCost: 97500, annualAvailableHours: 4000, machineUtilization: 0.80 },
    ...
    makeMachine('extruder-pipe-line', 'Pipe Extrusion Line 90mm (SSE + vacuum tank + haul-off + saw)',
      { annualDepreciation: 45000, maintenance: 15000, energy: 55000, floorSpace: 12000, indirectSupport: 9000, financeCost: 6000, annualAvailableHours: 6000, machineUtilization: 0.85 },
    ...
    makeMachine('extruder-profile-line', 'Profile Extrusion Line 75mm (SSE + calibration table + haul-off)',
      { annualDepreciation: 30000, maintenance: 12000, energy: 40000, floorSpace: 8000, indirectSupport: 7000, financeCost: 4000, annualAvailableHours: 5500, machineUtilization: 0.80 },
    ...
    makeMachine('extruder-sheet-line', 'Sheet Extrusion Line (die + 3-roll stack + winder)',
      { annualDepreciation: 90000, maintenance: 32000, energy: 85000, floorSpace: 20000, indirectSupport: 16000, financeCost: 11000, annualAvailableHours: 6000, machineUtilization: 0.82 },
    ...
    makeMachine('extruder-cable-line', 'Cable/Wire Line (crosshead + CV/cooling + capstan)',
      { annualDepreciation: 40000, maintenance: 14000, energy: 45000, floorSpace: 10000, indirectSupport: 8000, financeCost: 5000, annualAvailableHours: 6500, machineUtilization: 0.85 },
    ...
    makeMachine('extruder-coex-3', '3-Layer Co-Extrusion Line (3 extruders + feed block/manifold die)',
      { annualDepreciation: 120000, maintenance: 40000, energy: 95000, floorSpace: 22000, indirectSupport: 20000, financeCost: 14000, annualAvailableHours: 6000, machineUtilization: 0.80 },
    ...
    makeMachine('extruder-micro-tube', 'Medical Micro-Tubing Line (precision + laser gauge + cleanroom-ready)',
      { annualDepreciation: 60000, maintenance: 18000, energy: 30000, floorSpace: 8000, indirectSupport: 12000, financeCost: 7000, annualAvailableHours: 5000, machineUtilization: 0.75 },
    ...
    makeMachine('extrusion-finish-qa', 'Cut-off, Coil & Inspection Station',
      { annualDepreciation: 4000, maintenance: 2000, energy: 3000, floorSpace: 2000, indirectSupport: 2000, financeCost: 500, annualAvailableHours: 4000, machineUtilization: 0.80 },
    ...
    makeMachine('extrusion-leak-test', 'Pipe/Tube Pressure & Leak Test Rig',
      { annualDepreciation: 6000, maintenance: 2500, energy: 2000, floorSpace: 2000, indirectSupport: 2500, financeCost: 800, annualAvailableHours: 4000, machineUtilization: 0.70 },
    ...
    makeMachine('thermoform-pressure', 'Pressure Former (3–6 bar, cut-sheet)',
      { annualDepreciation: 32000, maintenance: 13000, energy: 22000, floorSpace: 7000, indirectSupport: 7000, financeCost: 4000, annualAvailableHours: 4000, machineUtilization: 0.80 },
    ...
    makeMachine('thermoform-twinsheet', 'Twin-Sheet Thermoformer',
      { annualDepreciation: 60000, maintenance: 24000, energy: 40000, floorSpace: 14000, indirectSupport: 12000, financeCost: 7500, annualAvailableHours: 4000, machineUtilization: 0.78 },
    ...
    makeMachine('thermoform-rollfed', 'Roll-Fed Inline Thermoformer (packaging)',
      { annualDepreciation: 90000, maintenance: 32000, energy: 55000, floorSpace: 16000, indirectSupport: 16000, financeCost: 11250, annualAvailableHours: 5000, machineUtilization: 0.85 },
    ...
    makeMachine('thermoform-oven', 'Standalone Sheet Pre-Heat Oven',
      { annualDepreciation: 9000, maintenance: 4000, energy: 16000, floorSpace: 3000, indirectSupport: 2000, financeCost: 1125, annualAvailableHours: 4000, machineUtilization: 0.80 },
    ...
    makeMachine('thermoform-trim-router', 'CNC Trim Router / Trim Robot (5-axis)',
      { annualDepreciation: 22000, maintenance: 9000, energy: 8000, floorSpace: 5000, indirectSupport: 5000, financeCost: 2750, annualAvailableHours: 4000, machineUtilization: 0.80 },
  ...
  labour: [
    ...
    },
    {
      ...
      fullyLoadedRatePerHr: 19.50,
      effectiveDate: '2026-06-14',
      sourceNote: 'UK thermoforming machine operator wage benchmark Jun 2026, incl. NI + benefits (sheet load, form, unload)',
      confidence: 'Medium',
    },
    {
      ...
      fullyLoadedRatePerHr: 22.50,
      effectiveDate: '2026-06-14',
      sourceNote: 'UK CNC router / trim-cell operator wage benchmark Jun 2026, incl. NI + benefits (programmes/jigs formed parts)',
      confidence: 'Medium',
    },
    {
      id: 'lab-de-skilled',
  ...
  energy: [
    {
      ...
      sourceNote: 'Electricity: Ofgem industrial tariff Q1 2026. Gas CORRECTED 2026-08: DESNZ '
