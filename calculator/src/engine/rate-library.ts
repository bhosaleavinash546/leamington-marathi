...
export const DEFAULT_RATE_LIBRARY: RateLibrary = {
  ...
  materials: [
    ...
    // ── Sheet Metal ────────────────────────────────────────────────────────
    { id: 'mat-dc01', grade: 'DC01', category: 'Mild Steel Sheet', pricePerKg: 0.87, scrapRecoveryPricePerKg: 0.20, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK steel coil, Jun 2026', confidence: 'Medium' },
    { id: 'mat-dc01-gi', grade: 'DC01 GI (Hot-dip Galvanised)', category: 'Galvanised Steel Sheet', pricePerKg: 1.06, scrapRecoveryPricePerKg: 0.20, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK galv coil, BIW bodywork standard. Jun 2026', confidence: 'Medium' },
    { id: 'mat-dc03-ga', grade: 'DC03 GA (Galvannealed)', category: 'Galvanised Steel Sheet', pricePerKg: 1.10, scrapRecoveryPricePerKg: 0.20, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK galvannealed coil, standard BIW inner panels. Jun 2026', confidence: 'Medium' },
    { id: 'mat-dp600', grade: 'DP600', category: 'AHSS Sheet', pricePerKg: 1.25, scrapRecoveryPricePerKg: 0.22, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK AHSS coil, Jun 2026', confidence: 'Medium' },
    { id: 'mat-hsla340', grade: 'HSLA 340', category: 'High Strength Steel Sheet', pricePerKg: 1.14, scrapRecoveryPricePerKg: 0.21, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK HSLA coil, Jun 2026', confidence: 'Medium' },
    { id: 'mat-22mnb5', grade: '22MnB5 (Hot Press Forming / Boron Steel)', category: 'Ultra-High Strength Steel', pricePerKg: 1.74, scrapRecoveryPricePerKg: 0.22, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK PHS coil for hot stamping (A/B-pillar, roof rail). Jun 2026', confidence: 'Low' },
    { id: 'mat-aa5182', grade: 'AA5182', category: 'Aluminium Sheet', pricePerKg: 3.25, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2700, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK Al sheet, Jun 2026', confidence: 'Medium' },
    { id: 'mat-ss304-sheet', grade: '304L Stainless Sheet', category: 'Stainless Steel Sheet', pricePerKg: 3.36, scrapRecoveryPricePerKg: 0.80, densityKgPerM3: 7900, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK stainless coil, food/pharma stampings. Jun 2026', confidence: 'Medium' },
    // ── Sheet Metal (extended — fabs & alloys) ─────────────────────────────
    { id: 'mat-aa5052', grade: 'AA5052-H32 Sheet', category: 'Aluminium Sheet', pricePerKg: 3.25, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2680, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK Al sheet stockholder Jun 2026. 5xxx series — marine/vehicle panels, excellent corrosion resistance. Yield 195 MPa.', confidence: 'Medium' },
    { id: 'mat-aa5083', grade: 'AA5083-H111 Sheet', category: 'Aluminium Sheet', pricePerKg: 3.46, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2660, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK Al sheet stockholder Jun 2026. 5xxx series — marine structures, shipbuilding. Higher strength than 5052. Yield 228 MPa.', confidence: 'Medium' },
    { id: 'mat-aa6082-sheet', grade: 'AA6082-T6 Sheet', category: 'Aluminium Sheet', pricePerKg: 3.62, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2700, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK Al sheet/plate stockholder Jun 2026. 6xxx series structural alloy — frames, structural parts. Yield 250 MPa.', confidence: 'Low' },
    { id: 'mat-aisi430', grade: 'AISI 430 Ferritic SS Sheet', category: 'Stainless Steel Sheet', pricePerKg: 2.94, scrapRecoveryPricePerKg: 0.70, densityKgPerM3: 7700, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK SS stockholder Jun 2026. Ferritic (magnetic) stainless — appliance panels, automotive trim. Moderate corrosion resistance. Yield 250 MPa.', confidence: 'Low' },
    { id: 'mat-ss316-sheet', grade: 'AISI 316L Stainless Sheet', category: 'Stainless Steel Sheet', pricePerKg: 4.41, scrapRecoveryPricePerKg: 0.90, densityKgPerM3: 7990, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK SS stockholder Jun 2026. 316L — food processing, medical, marine (Mo addition gives better chloride resistance than 304). Yield 170 MPa.', confidence: 'Medium' },
    { id: 'mat-dc01-ze', grade: 'DC01+ZE (Electrogalvanised)', category: 'Electrogalvanised Steel Sheet', pricePerKg: 0.93, scrapRecoveryPricePerKg: 0.20, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK steel coil Jun 2026. Thin zinc coating — automotive body, appliance housings. Better paintability than hot-dip. Yield 140 MPa.', confidence: 'Medium' },
    { id: 'mat-hsla420', grade: 'HSLA 420 Sheet', category: 'High Strength Steel Sheet', pricePerKg: 1.24, scrapRecoveryPricePerKg: 0.22, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK HSLA coil Jun 2026. 420 MPa min yield — structural reinforcements, crash components. Higher strength premium over HSLA 340.', confidence: 'Low' },
    // ── Injection Moulding (resins) ────────────────────────────────────────
    // coolTimeFactorSPerMm2: PP=3.16, ABS=2.0, PA66=2.0, PC=2.5, HDPE=3.5, POM=2.8, TPU=4.0
    { id: 'mat-pp', grade: 'PP Copolymer', category: 'Thermoplastic', pricePerKg: 1.12, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 900, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026', confidence: 'Medium' },
    { id: 'mat-abs', grade: 'ABS', category: 'Thermoplastic', pricePerKg: 1.68, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 1050, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026', confidence: 'Medium' },
    { id: 'mat-pa66gf30', grade: 'PA66 GF30', category: 'Thermoplastic', pricePerKg: 3.10, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1300, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026', confidence: 'Medium' },
    { id: 'mat-pc', grade: 'PC (Lexan)', category: 'Thermoplastic', pricePerKg: 2.52, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1200, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026', confidence: 'Medium' },
    { id: 'mat-hdpe', grade: 'HDPE', category: 'Thermoplastic', pricePerKg: 1.06, scrapRecoveryPricePerKg: 0.12, densityKgPerM3: 960, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026', confidence: 'Medium' },
    { id: 'mat-pom', grade: 'POM / Acetal (Delrin)', category: 'Thermoplastic', pricePerKg: 2.05, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1410, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026. coolFactor ~2.8 s/mm²', confidence: 'Medium' },
    { id: 'mat-pbt-gf30', grade: 'PBT GF30', category: 'Thermoplastic', pricePerKg: 3.10, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1520, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026. Common connector/housing material.', confidence: 'Medium' },
    { id: 'mat-tpu-shore85', grade: 'TPU Shore 85A', category: 'Thermoplastic Elastomer', pricePerKg: 2.52, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1200, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor, Jun 2026. coolFactor ~4.0 s/mm²', confidence: 'Low' },
    // ── Polyethylene family ────────────────────────────────────────────────────
    { id: 'mat-ldpe', grade: 'LDPE (2426H)', category: 'Thermoplastic', pricePerKg: 0.87, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 910, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. EBM film bags. coolFactor ~3.5 s/mm²', confidence: 'Medium' },
    { id: 'mat-lldpe', grade: 'LLDPE C6', category: 'Thermoplastic', pricePerKg: 0.93, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 920, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Stretch/packaging film, rotomoulding. coolFactor ~3.5 s/mm²', confidence: 'Medium' },
    // ── PP grades ──────────────────────────────────────────────────────────────
    { id: 'mat-pp-homo', grade: 'PP Homopolymer (MFI 12)', category: 'Thermoplastic', pricePerKg: 0.96, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 905, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. High stiffness housings, caps. coolFactor ~3.16 s/mm²', confidence: 'Medium' },
    { id: 'mat-pp-impact', grade: 'PP Impact Copolymer (PP-B)', category: 'Thermoplastic', pricePerKg: 1.01, scrapRecoveryPricePerKg: 0.10, densityKgPerM3: 900, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Bumpers, battery cases. coolFactor ~3.16 s/mm²', confidence: 'Medium' },
    // ── PET ────────────────────────────────────────────────────────────────────
    { id: 'mat-pet-bg', grade: 'PET Bottle Grade (1101)', category: 'Thermoplastic', pricePerKg: 1.21, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1380, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. SBM beverage bottles. coolFactor ~3.0 s/mm²', confidence: 'Medium' },
    { id: 'mat-pet-gf30', grade: 'PET GF30 (Engineering)', category: 'Thermoplastic', pricePerKg: 3.05, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1520, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Gears, precision parts. coolFactor ~2.5 s/mm²', confidence: 'Medium' },
    // ── PVC ────────────────────────────────────────────────────────────────────
    { id: 'mat-upvc', grade: 'Rigid PVC (uPVC pipe grade)', category: 'Thermoplastic', pricePerKg: 0.83, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1400, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Pipes, window profiles. coolFactor ~2.5 s/mm²', confidence: 'Medium' },
    { id: 'mat-fpvc', grade: 'Flexible PVC (fPVC plasticised)', category: 'Thermoplastic', pricePerKg: 1.16, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1250, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Cables, hoses, medical tubing. coolFactor ~3.0 s/mm²', confidence: 'Medium' },
    // ── PS grades ──────────────────────────────────────────────────────────────
    { id: 'mat-gpps', grade: 'GPPS (Crystal PS)', category: 'Thermoplastic', pricePerKg: 1.00, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1050, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Clear, rigid, brittle. CD cases, cutlery. coolFactor ~2.0 s/mm²', confidence: 'Medium' },
    { id: 'mat-hips', grade: 'HIPS (High Impact PS)', category: 'Thermoplastic', pricePerKg: 0.97, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1040, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. TV housings, fridge liners, thermoforming sheet. coolFactor ~2.0 s/mm²', confidence: 'Medium' },
    // ── PC/ABS Blend ───────────────────────────────────────────────────────────
    { id: 'mat-pc-abs', grade: 'PC/ABS Blend (automotive grade)', category: 'Thermoplastic', pricePerKg: 1.95, scrapRecoveryPricePerKg: 0.08, densityKgPerM3: 1150, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Automotive interior, electronics housings. coolFactor ~2.2 s/mm²', confidence: 'Medium' },
    // ── Polyamide (PA) grades ──────────────────────────────────────────────────
    { id: 'mat-pa6', grade: 'PA6 Unfilled', category: 'Thermoplastic', pricePerKg: 1.68, scrapRecoveryPricePerKg: 0.06, densityKgPerM3: 1130, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Gears, under-hood. Moisture sensitive — dry before moulding. coolFactor ~2.0 s/mm²', confidence: 'Medium' },
    { id: 'mat-pa6-gf30', grade: 'PA6 GF30', category: 'Thermoplastic', pricePerKg: 2.52, scrapRecoveryPricePerKg: 0.05, densityKgPerM3: 1280, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Structural PA6 with glass fill. coolFactor ~2.0 s/mm²', confidence: 'Medium' },
    { id: 'mat-pa66', grade: 'PA66 Unfilled', category: 'Thermoplastic', pricePerKg: 1.89, scrapRecoveryPricePerKg: 0.06, densityKgPerM3: 1140, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK resin distributor Jun 2026. Higher temp than PA6. Connectors, structural. coolFactor ~2.0 s/mm²', confidence: 'Medium' },
    // ── High-Performance ───────────────────────────────────────────────────────
    { id: 'mat-peek', grade: 'PEEK Unfilled', category: 'High-Performance Thermoplastic', pricePerKg: 76.00, scrapRecoveryPricePerKg: 5.00, densityKgPerM3: 1300, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK speciality resin supplier Jun 2026. Aerospace/medical/oil&gas. High temp (Tg~143°C, use to 250°C). coolFactor ~2.5 s/mm²', confidence: 'Low' },
    { id: 'mat-peek-gf30', grade: 'PEEK GF30', category: 'High-Performance Thermoplastic', pricePerKg: 93.00, scrapRecoveryPricePerKg: 5.00, densityKgPerM3: 1430, region: 'UK', effectiveDate: '2026-06-14', sourceNote: 'UK speciality resin supplier Jun 2026. High-stiffness structural PEEK.', confidence: 'Low' },
    // ── Casting alloys ─────────────────────────────────────────────────────
