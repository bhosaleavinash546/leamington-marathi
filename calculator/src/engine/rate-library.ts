...
export const DEFAULT_RATE_LIBRARY: RateLibrary = {
  ...
  materials: [
    ...
    { id: 'mat-hrpo', grade: 'HRPO (Hot Rolled Pickled & Oiled)', category: 'Mild Steel Sheet', pricePerKg: 0.72, scrapRecoveryPricePerKg: 0.18, densityKgPerM3: 7850, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK steel coil Jun 2026. Hot-rolled, pickled and oiled — structural fabrication, heavy-gauge brackets, lower cost than CR. Yield 250 MPa.', confidence: 'Medium' },
    { id: 'mat-aa5754-sheet', grade: 'AA5754-H22 Sheet', category: 'Aluminium Sheet', pricePerKg: 3.38, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2660, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK Al sheet stockholder Jun 2026. 5754 H22 — automotive body closures, truck panels. Excellent formability. Yield 140 MPa.', confidence: 'Medium' },
    { id: 'mat-aa6061-sheet', grade: 'AA6061-T6 Sheet/Plate', category: 'Aluminium Sheet', pricePerKg: 3.72, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2700, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK Al sheet stockholder Jun 2026. 6061 T6 — general structural, aerospace, vehicle frames. Yield 276 MPa. Good weldability.', confidence: 'Medium' },
    { id: 'mat-aa6063-sheet', grade: 'AA6063-T5 Sheet', category: 'Aluminium Sheet', pricePerKg: 3.55, scrapRecoveryPricePerKg: 0.50, densityKgPerM3: 2690, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK Al sheet stockholder Jun 2026. 6063 T5 — architectural panels, window frames, radiators. Yield 145 MPa. Anodises well.', confidence: 'Low' },
    { id: 'mat-aa3003-sheet', grade: 'AA3003-H14 Sheet', category: 'Aluminium Sheet', pricePerKg: 3.05, scrapRecoveryPricePerKg: 0.48, densityKgPerM3: 2730, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK Al sheet stockholder Jun 2026. 3003 H14 — heat exchangers, chemical equipment, fuel tanks, cookware. Best formability of common Al alloys. Yield 145 MPa.', confidence: 'Low' },
    { id: 'mat-c110-copper', grade: 'C110 ETP Copper Sheet', category: 'Copper & Brass Sheet', pricePerKg: 9.85, scrapRecoveryPricePerKg: 5.50, densityKgPerM3: 8940, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK copper stockholder Jun 2026. C110 ETP copper — busbars, electrical contacts, heat sinks, roofing. 99.9% Cu, 100% IACS. Yield 70 MPa.', confidence: 'Medium' },
    { id: 'mat-cz108-brass', grade: 'CZ108 Brass Sheet (70/30)', category: 'Copper & Brass Sheet', pricePerKg: 7.42, scrapRecoveryPricePerKg: 4.20, densityKgPerM3: 8530, region: 'UK', effectiveDate: '2026-06-16', sourceNote: 'UK brass stockholder Jun 2026. CZ108 70/30 cartridge brass — decorative panels, heat exchangers, plumbing fittings. Excellent cold formability. Yield 105 MPa.', confidence: 'Medium' },
