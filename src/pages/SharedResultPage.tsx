  ...
  if (error) return (
    <div className="min-h-screen bg-navy-950 flex items-center justify-center px-4">
      <div className="text-center">
        <Lock size={48} className="mx-auto mb-4 text-slate-500" />
    ...
    <div className="min-h-screen bg-navy-950 pt-20 pb-16 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <p className="text-slate-500 text-sm">Generated by <span className="text-gold-400 font-semibold">BrainSpark</span> · AI Cost Reduction Platform</p>
