...
const FAQ: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Which processes are covered, and how are the thresholds justified?', a: 'Four families — CNC machining, injection moulding, high-pressure die casting, and sheet metal / stamping — with 22 rules in total, each carrying its threshold, unit, rationale, suggested fix and a cited source. You can read the whole catalogue before uploading anything. They are industry design guidelines, not laws of physics: a capable supplier will beat several of them, so treat a finding as the start of a conversation with your supplier rather than a verdict.' },
        ...
        {!search && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-8">
              {[
                { icon: Boxes,      color: 'text-cyan-400',   bg: 'bg-cyan-500/10',   border: 'border-cyan-500/20',  title: 'DFM / DFA Studio', desc: 'Upload a STEP or IGES file and get a measured manufacturability report — no AI anywhere on the path that produces the numbers. An OpenCascade kernel measures draft angles and wall thickness on the tessellation (so it works on freeform castings, not just planes and cylinders), and recognises holes, counterbores, countersinks, pockets, slots, chamfers, fillets, ribs and sheet-metal bends from the topology. 22 cited rules across machining, injection moulding, HPDC and stamping, each reporting pass, fail or NOT EVALUATED with the reason — findings are priced by the same engines the rest of the tool uses, or say plainly that they cannot be. Assembly DFA decomposes a multi-solid STEP, measures each part\'s alpha/beta symmetry by rotating it, groups repeated parts by shape signature, and withholds the design-efficiency index until you answer the three minimum-part questions. Branded PDF and multi-sheet Excel. See /dfm-studio.' },
