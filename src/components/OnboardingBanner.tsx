            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3">
              {FEATURES.map(({ to, icon: Icon, title, desc }) => (
                <Link
                  key={to}
                  to={to}
                  className="group flex items-start gap-3 p-3 rounded-xl bg-white/5 border border-white/8 hover:border-gold-500/30 hover:bg-white/6 transition-ui focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-400/50"
                >
