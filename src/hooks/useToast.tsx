  ...
  return createPortal(
    <div className="fixed bottom-6 right-6 z-[9999] flex flex-col gap-2 pointer-events-none">
      {[...toastQueue].map(t => {
        ...
        return (
          <div key={t.id} className={`flex items-center gap-3 px-4 py-3 rounded-xl border backdrop-blur-md shadow-2xl text-sm font-medium pointer-events-auto max-w-sm animate-in slide-in-from-right-4 fade-in duration-300 ${STYLES[t.type]}`}>
