...
export const EE_COMPONENTS: EeComponent[] = [
  {
    ...
    ideas: [
      ...
      },
      {
        ...
        mfg: 'High capex per cell (~£0.68M) but scalable; justified at >500K units/year per harness variant. Requires design-for-automation: straight runs, standardised connector pitches.',
  ...
  },
  {
    ...
    ideas: [
      ...
      },
      {
        ...
        lev: 'Architecture',
        save: 'Dealer visit cost −£68-128/vehicle/update; software rework −30%',
        ...
        why: 'Eliminating dealer reflash events saves £68–128 per vehicle per update cycle, compounds over the fleet, and monetises software updates as revenue.',
      ...
      },
      {
        ...
        lev: 'Design',
        save: 'Delete DC-DC converter (£68-128), LV harness −25%',
        ...
        why: 'DC-DC converter is typically £68–128 BOM; 48V LV harness is 25% lighter. For BEV, where 12V battery serves only accessories, the case for a separate 12V subsystem is purely inertia.',
    ...
    ideas: [
      {
        ...
        lev: 'Standardization',
        save: 'HU BOM −20-30%, NRE −£6.8-12.75M per programme',
      ...
      },
      {
        ...
        lev: 'Architecture',
        save: 'Middleware development −£13-21.25M, app ecosystem standard',
        ...
        why: 'Proprietary middleware costs £13–21.25M per programme in development, carries constant app-compatibility debt, and has no app ecosystem. AAOS delivers this for a per-vehicle royalty that is lower than the development saving.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete cluster ECU + housing (£38-77), PCB area −30%',
        ...
        why: 'Instrument cluster ECU is typically £38–77 BOM. Running it as a display output from the HU SoC costs the SoC a few percent extra processing headroom but deletes an entire ECU assembly.',
      ...
      },
      {
        ...
        why: 'Euro NCAP mandates DMS from 2024. A standalone DMS ECU at £26–51 is added cost for every vehicle; the ADAS SoC already has sufficient compute headroom.',
      ...
      },
      {
        ...
        why: 'Standalone NAV hardware is £34–68 BOM for storage and processing that the HU SoC already has. Cloud maps are always current, removing costly annual map update logistics.',
  ...
  },
  {
    ...
    ideas: [
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete DC-DC unit (£68-128), housings and wiring',
        ...
        why: 'Standalone DC-DC converter is £68–128 BOM with its own housing, cooling and connectors. Integration into OBC removes all of these as standalone items.',
      ...
      },
      {
        ...
        lev: 'Technology',
        save: 'Delete main relay (£13-26), faster switching, no arc wear',
...
export const EE_TRENDS: EeTrendItem[] = [
  ...
  { t: 'Android Automotive OS displacing proprietary middleware', status: 'Mainstream', save: 'Middleware NRE −£13-21.25M', dir: 'Volvo (2021), Renault (2024), Honda, GM adopting AAOS. Qualcomm SA8295 + AAOS becoming the default HU stack for European/Korean OEMs. Reduces HMI software development cycle from 3 years to 18 months.' },
  ...
  { t: 'Integrated OBC + DC-DC + on-board charger consolidation', status: 'Mainstream', save: 'Delete DC-DC unit (£68-128)', dir: 'BYD 8-in-1 integrates OBC, DC-DC and PDU. Hyundai E-GMP integrated OBC (11 kW AC + 800V DC fast charge + 12V DC-DC in one unit). Consolidation reduces HV connector count by 4–6 and deletes separate cooling circuit.' },
];
