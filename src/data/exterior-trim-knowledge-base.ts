    ...
    ideas: [
      {
        ...
        lev: 'Spec opt.',
        save: '£15-27/unit (delete 1 actuator motor + linkage + ECU zone)',
        ...
        mfg: 'Deletes one actuator motor (brushless DC £6.8-12), one gear-train linkage assembly, one ECU control channel, and the associated wiring harness branch (1.2-2.0m sub-loom). AGS assembly fixture is simplified — single-motor drive train vs dual-motor with synchronisation requirement.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '£19-32/unit (delete grille mesh, surround, separate AGS sub-assembly)',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '£3.4-7.6/unit (delete separate radar bracket + 4-6 fasteners)',
        ...
        mfg: 'Radar positioning boss moulded into grille surround — no additional tool required beyond adding bosses/locators in the existing grille tool (tool modification £2.5-6.8K vs separate bracket tool £13-21.3K). Deletes separate bracket, 4-6 fasteners and torque operations. Front-of-dash (FOD) assembly operation simplified.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '£5.1-10/unit (delete separate air curtain duct + fasteners)',
      ...
      },
      {
        ...
        lev: 'Design',
        save: '£10-17/unit (delete 1 motor + 1 separate linkage drive)',
        ...
        mfg: 'Deletes one brushless DC motor (£6.8-12), one motor bracket, one independent control harness stub, and its ECU driver circuit. Common shaft adds a minor linkage cost (£1.7-2.5) but net saving is £8.5-14/unit. Assembly sequence simplifies to single motor attachment and one electrical connection.',
    ...
    ideas: [
      {
        ...
        lev: 'Consolidation',
        save: '£12-22/unit (delete LED board + wiring + diffuser + ECU channel)',
      ...
      },
      {
        ...
        lev: 'Design',
        save: '£1.5-3/unit (delete clips + boss tooling + assembly ops)',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '£0.5-1.2/unit piece price (volume consolidation) + £13-25.5K tooling NRE per model avoided',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '£0.3-0.8/unit (1 part number deleted) + 50% tooling on badge',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '£0.4-1/unit + tooling rationalisation',
    ...
    ideas: [
      {
        ...
        lev: 'Process',
        save: '£6.8-15/unit (delete external paint operation per cladding set)',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '50% arch liner tooling cost (£21-38.3K per derivative saved) + 1 part number deleted',
        ...
        mfg: 'One injection tool (£21-38.3K per size) replaces two (£43-76.5K combined). One part number on BOM. If the tool uses a flippable cavity, the same tool physically produces both L and R variants in sequence — maximum tooling amortisation. Sub-assembly operation is identical; the liner is simply flipped at installation.',
      ...
      },
      {
        ...
        lev: 'Material',
        save: '£4.3-8.5/unit (delete secondary reinforcement bracket at mounting points)',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '£10-19/unit (delete bracket stamping + weld operation + reinforcement)',
        ...
        mfg: 'Tow bracket integration is a design-time change — the Al extrusion or HPDC beam die is modified to include mounting bosses as cast features. Eliminates the bracket stamping tool (£13-21.3K), bracket welding/press operation, weld inspection, and the bracket part itself. On Al extrusion beams, the boss is machined from the extrusion — no additional casting tool required.',
      ...
      {
        t: 'Side step delete on non-4x4 specification — £47-102 per vehicle saving',
        lev: 'Spec opt.',
        save: '£47-102/unit (delete side step tube + mounting brackets + sub-assembly)',
        ...
        why: 'Side steps are specified uniformly across variants for dealer simplicity but represent £47-102 of avoidable cost on variants where the functional case is weak (lower ride height, urban customer profile). Offering step deletion as a standard non-spec derivative differentiator is a straightforward VAVE saving — the step can remain as a dealer-fit or factory option on high-ride variants.',
    ...
    ideas: [
      {
        ...
        lev: 'Standardization',
        save: '£3.4-7.6/unit (reduce seal SKUs; volume pricing on common profile)',
        ...
        mfg: 'One extrusion die (£6.8-12.8K) replaces 3-4 derivative dies (£21-38.3K combined). One compound specification and one colour specification across all variants. Volume consolidation on one rubber compound improves raw material pricing and reduces safety-stock. End-cap tooling may remain derivative-specific (body angle variation) but is low-cost injection tool.',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '£2.5-6/unit (compound volume + die amortisation)',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '£2.5-5.1/unit (delete seam sealer application, material and baking)',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '£1-2/unit (delete separate end-cap parts + assembly)',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '£1.7-3.4/unit (2 SKUs consolidated to 1; volume pricing)',
...
export const EXTERIOR_TRIM_TRENDS: ExteriorTrimTrend[] = [
  {
    ...
    save: 'Delete AGS + grille mesh + surround: £19-32/unit',
  ...
  },
  {
    ...
    status: 'Mainstream',
    save: 'Delete paint process: £6.8-15/unit for cladding set',
  ...
  },
  {
    ...
    status: 'Mainstream',
    save: 'Delete 4-6 clips + body bosses + assembly ops: £1.5-3/unit',
  ...
  },
  {
    ...
    save: '£3.4-7.6/unit seal cost + £21-38.3K tooling NRE per derivative avoided',
  ...
  },
  {
    ...
    save: 'Delete sealer application + material + bake: £2.5-5.1/unit per Al door',
  ...
  },
  {
    ...
    status: 'Emerging → Mainstream',
    save: 'Delete 1 actuator + zone: £15-27/unit',
  ...
  },
  {
    ...
    status: 'Mainstream',
    save: 'Delete bracket + 4-6 fasteners: £3.4-7.6/unit',
  ...
  },
  {
    ...
    status: 'Emerging → Mainstream',
    save: 'Delete 2 end-cap parts + assembly: £1-2/unit',
  ...
  },
  {
    ...
    status: 'Emerging',
    save: '50% arch liner tooling: £21-38.3K per derivative saved',
...
export const EXTERIOR_TRIM_MFG_LEVERS: ExteriorTrimMfgItem[] = [
  {
    ...
    lev: 'Process',
    save: '£6.8-15/unit for cladding set; 35-50% energy per cladding part',
  ...
  },
  {
    ...
    lev: 'Standardization',
    save: '£21-38.3K die NRE per derivative; 15-20% compound pricing',
  ...
  },
  {
    ...
    lev: 'Consolidation',
    save: 'Delete 2 parts + assembly: £1-2/unit; 1 assembly operation removed',
  ...
  },
  {
    ...
    lev: 'Tooling',
    save: '50% arch liner tooling: £21-38.3K per liner set',
...
export const EXTERIOR_TRIM_OEM_BENCHMARKS: ExteriorTrimBenchmark[] = [
  {
    ...
    moves: [
      'Sealed smooth front fascia — no open grille mesh, no AGS, no chrome surround: saves £26-38/unit vs comparable C-segment SUV with AGS',
      'Identical front/rear T-badge (same P/N, VHB bonded): one badge tool, one SKU, peel-and-press install — saves £10-15.3K tooling + £0.5/unit piece price',
  ...
  },
  {
    ...
    moves: [
      'VHB 5952 badge bonding standardised across all G-series nameplates from 2019: deleted body boss tooling from BIW, saves £1.9/unit + £25.5K tooling NRE per model',
  ...
  },
  {
    ...
    moves: [
      'Valeo mono-motor AGS (single actuator, common linkage shaft): validated on Renault Arkana Cd 0.28 — saved £17/unit vs dual-motor AGS; adopted Renault Megane E-Tech same architecture',
      'Continental single-zone AGS on Ford Puma (2022): deleted upper-zone motor and wiring on standard 1.0T EcoBoost spec — £15 saving per vehicle retained on lower trims',
      'Valeo: integrated radar boss in AGS grille moulding on Stellantis STLA Medium (2022): deleted separate radar bracket, 6 fasteners and £5.5/unit at assembly',
  ...
  },
  {
    ...
    moves: [
      'Defender L663 tow bracket integrated into rear bumper cross-beam structure: deleted standalone bracket weld and inspection — saves £13/unit, stronger load path vs welded bracket',
      'L550 PP-LGF front engine shield (2019): deleted 3 steel reinforcement brackets vs HDPE shield — saves £7.6/unit, 18% mass reduction, integral clip bosses moulded in',
      'Defender air curtain integration in front fascia moulding: deleted separate clip-in duct inserts, saves £6/unit — Cd benefit of −0.005 maintained with moulded-in channel',
      'Common belt-line seal cross-section across Defender 90/110/130 (Cooper Standard): one die, three lengths — saves £23.8K die NRE vs derivative-specific profiles; 11% unit price improvement',
    ],
  },
];
