...
export const BOM_TREE = {
  Powertrain: {
    'Engine structure': ['engine block', 'cylinder head', 'crankshaft', 'camshaft', 'pistons and conrods', 'engine bearings', 'valve train', 'timing drive', 'engine gaskets and seals', 'engine mounts'],
    ...
    'Exhaust & aftertreatment': ['exhaust manifold', 'catalytic converter', 'gasoline particulate filter', 'muffler and silencer', 'exhaust pipes', 'lambda sensors'],
  ...
  Chassis: {
    ...
    'Braking': ['brake caliper', 'brake disc', 'brake pads', 'brake-by-wire unit', 'abs esc module', 'brake booster', 'electronic parking brake', 'brake pedal'],
  ...
  Driveline: {
    'Transmissions': ['automatic transmission', 'dual clutch transmission', 'cvt transmission', 'dedicated hybrid transmission', 'torque converter', 'transmission control unit'],
  ...
  Exterior: {
    'Front & rear end': ['front bumper fascia', 'rear bumper fascia', 'grille', 'illuminated front panel', 'underbody aero panels', 'active aero flaps'],
    'Lighting': ['headlamp', 'matrix led module', 'tail lamp', 'fog lamp', 'light bar'],
    'Glazing & vision': ['windscreen', 'side glazing', 'panoramic roof glass', 'rear glazing', 'door mirror', 'camera mirror', 'wiper system', 'washer system'],
  ...
  Interior: {
    ...
    'Safety & restraint': ['airbag', 'seatbelt', 'seatbelt pretensioner', 'isofix anchors', 'occupant sensing'],
  ...
  Electrical: {
    'E/E architecture': ['wiring harness', 'hv harness', 'zonal controller', 'central computer', 'domain controller', 'ecu', 'fuse box', 'e-fuse', 'relay', 'connectors'],
    ...
    'Connectivity': ['telematics unit', 'antenna', 'satellite module', 'v2x module', 'uwb digital key module', 'central gateway'],
    ...
    'Charging & power': ['charge port', 'bidirectional charger', 'wireless vehicle charging', 'automated charging robot'],
  },
};
