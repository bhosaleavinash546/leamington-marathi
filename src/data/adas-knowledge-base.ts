    ...
    ideas: [
      {
        ...
        lev: 'Technology',
        save: 'Delete 1× radar (€40-80), depth perception without radar',
        ...
        why: 'Forward radar is €40–80 BOM. Deleting it with camera-only depth sensing removes a sensor, its housing, connector and harness — and simplifies the perception fusion stack.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete surround-view ECU (€30-60), consolidate 4 ISPs',
        ...
        why: 'A dedicated surround-view ECU (€30–60) does only one job. Moving it to the ADAS SoC costs incremental compute but deletes an entire ECU housing and assembly.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete rain sensor module (€8-15) + light sensor (€3-6)',
      ...
      },
      {
        ...
        why: 'Euro NCAP mandate means every new model needs DMS. A standalone ECU at €30–60 is avoidable cost when the ADAS SoC already has capacity. Deletion saves BOM on every vehicle sold.',
      ...
      },
      {
        ...
        lev: 'Architecture',
        save: 'Delete forward radar (€40-80) + processing ECU',
    ...
    ideas: [
      {
        ...
        lev: 'Consolidation',
        save: 'Delete standalone BSM radar (€20-35/corner), 2 ECU stubs',
        ...
        why: 'Standalone BSM radars (€20–35 each) are added to the rear quarters for NCAP-mandated blind-spot detection. A multi-function corner radar achieves all three functions without added hardware.',
      ...
      },
      {
        ...
        why: 'LiDAR is €200–800+ per unit depending on specification. Right-sizing FOV, range and scan rate to the actual use-case eliminates over-specification — the largest single LiDAR cost lever.',
      ...
      },
      {
        ...
        lev: 'Technology',
        save: 'Delete LiDAR (€200-800+); 4D radar €80-150',
        ...
        why: 'Scanning LiDAR at €200–800 per unit is the largest single ADAS BOM item for non-robotaxi vehicles. 4D imaging radar at €80–150 delivers comparable object detection for highway L2+ at 70–80% cost reduction.',
    ...
    ideas: [
      {
        ...
        lev: 'Spec opt.',
        save: 'Delete knee airbag module (€18-35 per side)',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete 6–8 satellite sensors (€4-8 each), simplify wiring',
        ...
        why: 'Each satellite sensor is €4–8 BOM. Deleting 8 saves €32–64 per vehicle. Central MEMS achieves equivalent crash discrimination with higher MEMS sensitivity at lower system cost.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete far-side airbag module (€25-45), simplify far-side wiring',
      ...
      },
      {
        ...
        mat: 'Proven',
        risk: 'Low',
        tech: 'Design the curtain airbag as a symmetric bilaterally-reversed part — one bag pattern and one inflation tube geometry serves both left and right sides. The inflator location and routing adapt via a symmetric bracket. Autoliv achieves this on BMW G-series. Saves one full bag-sewing tool set (€0.8–1.5M NRE) per programme.',
        ...
        why: 'Curtain airbag tooling NRE is significant (€1–3M per programme across L+R). Commonising L/R also consolidates volume on one SKU for better piece-price leverage with Autoliv/ZF TRW/Joyson.',
  ...
  },
  {
    ...
    ideas: [
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: 'Delete external load-limiter assembly (€4-9), part count −3',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: 'SKU reduction −60%, tooling NRE −€0.5-1.5M',
      ...
      },
      {
        ...
        lev: 'Spec opt.',
        save: 'Delete BIS system (€45-90 per seating position)',
        ...
        why: 'BIS adds significant cost per rear outboard position — €45–90 for the additional hardware integration vs a B-pillar retractor. On non-sport variants with a conventional bench seat, BIS provides no meaningful NCAP advantage.',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: 'SKU reduction −70%, tooling −€0.2-0.4M',
...
export const ADAS_TRENDS: AdasTrendItem[] = [
  { t: 'Camera-centric perception replacing radar-fusion on L2 vehicles', status: 'Mainstream', save: 'Forward radar delete (€40-80)', dir: "Tesla Vision (2021) validated camera-only AEB at scale. Mobileye EyeQ6L camera-centric L2+ targets emerging market OEMs at <$50/vehicle. NCAP 2026 updates being monitored — most OEMs hedging with radar-optional architecture rather than full delete." },
  { t: '4D imaging radar displacing LiDAR on L2+ ADAS', status: 'Emerging → Mainstream', save: 'LiDAR delete on L2+: −€200-800', dir: 'Continental ARS540, Arbe Phoenix, ZF PREMIUM 4D entering volume production 2024–25. Stellantis STLA uses 4D radar as primary ranging sensor. LiDAR reserved for L3+. 4D radar at €80–150 vs LiDAR at €200–800+.' },
  ...
  { t: 'Euro NCAP DMS mandate (2024) driving shared-SoC DMS adoption', status: 'Mandatory', save: 'Delete standalone DMS ECU (€30-60)', dir: 'Euro NCAP 2024 requires camera-based driver drowsiness and distraction monitoring for 5-star rating. Mobileye EyeQ5H shared ADAS+DMS validated in production (Zeekr 001, 2023). Continental ContiGuard, ZF TRW ProViu360 all consolidating DMS onto shared ADAS SoC.' },
  ...
  { t: 'Airbag count right-sizing on BEV high-floor platforms', status: 'Emerging', save: 'Knee airbag delete per vehicle (€18-35/side)', dir: 'Tesla Model 3/Y, BYD Seal, Rivian R1T all achieve NCAP 5-star without knee airbags due to BEV high-sill floor geometry. NCAP analysis confirms femur load reduction from raised H-point. BMW iX and Mercedes EQS also omit knee airbag.' },
...
export const ADAS_COST_STRUCTURE: AdasCostEntry[] = [
  ...
  { label: 'LiDAR (L3 models)', pct: 18, color: '#1d9488', note: 'Largest unit-cost sensor (€200–800+). Solid-state right-sizing and 4D imaging radar substitution are the two principal levers. Reserved for L3+ vehicles; right-sized FOV for highway vs full 360° scan.' },
