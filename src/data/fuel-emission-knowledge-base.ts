    ...
    ideas: [
      {
        ...
        why: 'Saddle geometry adds tooling complexity (€60-120K per tool vs €35-60K flat), increases wall-thickness variation risk and requires a transfer jet pump to move fuel between lobes — each lobe needs its own fuel level sender. Flat topology deletes the transfer pump and second sender.',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '€90-150K tooling NRE per derivative',
        ...
        mfg: 'One blow-mould tool (€35-60K) replaces 2-3 derivative tools (€100-180K combined). Common strap/bracket tooling. One part number family rationalisation reduces logistics complexity across the supply chain.',
        why: 'Each unique tank shape requires dedicated blow-mould tooling, testing, homologation and supplier qualification. Sharing the envelope across platform derivatives typically saves €90-150K NRE and improves piece price by 3-6% through volume consolidation on one supplier.',
      ...
      },
      {
        ...
        lev: 'Material',
        save: '€6-11/unit (50-60% rail cost)',
        ...
        mfg: 'Al rail is extruded and CNC-machined vs drawn/formed SS tube with MIG-welded injector bungs. Al machining cycle time is 40-50% shorter; material cost is substantially lower per kg (Al ~€2.5/kg vs SS ~€4.5/kg for fuel-grade alloy).',
        why: 'Stainless steel rail accounts for 65-75% of the fuel rail BOM cost vs aluminium equivalent. Al rail is also 65% lighter per unit. At platform volumes the piece-price saving scales directly with unit count — €6-11 per car with no performance trade-off.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '€25-45/unit (delete PFI injectors + rail + ECU channel)',
        ...
        why: 'Dual-injection systems add €25-45/unit for what is essentially a carbon-management band-aid on legacy GDI designs. Advanced GDI spray design makes the workaround unnecessary. Deleting PFI also reduces EVAP purge loading (fewer fuel vapour sources) and simplifies OBD-II injector monitoring.',
    ...
    ideas: [
      {
        ...
        lev: 'Spec opt.',
        save: '€5-10/unit (canister size ↓ 25-35%)',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '€12-22/unit (delete purge valve + ECU channel + harness)',
      ...
      },
      {
        ...
        lev: 'Design',
        save: '€8-15/unit (delete external reference orifice + vacuum pump variant)',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '€1.50-3.50/unit + €25-45K tooling NRE per derivative avoided',
        ...
        mfg: 'One bracket tool (€8-12K progressive die) replaces 3-4 derivative tools (€25-45K combined). Common sub-assembly line for all derivatives. Reduces supplier SKU count and safety-stock holding.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '€0.80-1.80/unit + 1 assembly operation',
        ...
        why: 'The bleed restrictor exists to compensate for standard-grade carbon adsorption performance. Upgrading the carbon grade removes the root cause and allows the restrictor to be deleted. Carbon grade upgrade cost (€0.30-0.60/unit) is more than offset by deletion savings.',
  ...
  },
  {
    ...
    ideas: [
      ...
      },
      {
        ...
        lev: 'Spec opt.',
        save: '€15-28/unit (tank volume ↓, mounting simplification)',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '€5-12/unit washcoat + €80-150K qualification cost per variant avoided',
      ...
      },
      {
        ...
        why: 'EGR cooler is one of the higher-cost engine ancillaries (€45-90 depending on engine). Over-sizing for a rarely-achieved peak condition means every vehicle in the fleet carries cost for a condition that 90% of customers never encounter. Right-sizing to real-world demand removes the excess without compliance risk.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '€25-50/unit (delete separate DPF housing + can)',
    ...
    ideas: [
      {
        ...
        lev: 'Spec opt.',
        save: '€5-12/unit substrate cost ↓, backpressure ↓',
      ...
      },
      {
        ...
        lev: 'Material',
        save: '€8-25/unit (PGM is 40-60% of TWC cost)',
        bench: 'BASF EMICAT advanced Pd-dominant TWC (2021, adopted by Toyota/BMW); Umicore ZPGM and reduced-Rh TWC programmes (2022)',
        v8: 'fav',
        mat: 'Proven',
        risk: 'Med',
        new: 1,
        tech: 'Platinum group metal (PGM) loading — particularly Rhodium (Rh) which is the most expensive PGM at €100-300/troy oz — accounts for 40-60% of three-way catalyst BOM cost. BASF EMICAT technology uses advanced Pd-dominant washcoat chemistry with nano-particle stabilisation, achieving equivalent NOx/HC/CO conversion efficiency at 30-40% lower total PGM loading vs 2018-era TWC. Umicore ZPGM research targets partial Rh replacement with base metals (Mn, Fe). Toyota specified BASF reduced-PGM washcoat from 2021 on the 2.5L A25A-FXS; BMW adopted similar BASF formulations on B38/B48 from 2022.',
        mfg: 'PGM loading is applied in the washcoat slurry step at the catalyst supplier — no OEM manufacturing change. Reduced PGM loading reduces washcoat batch cost and stabilises BOM against PGM spot-price volatility. Pd price is €35-70/troy oz vs Rh at €100-300/troy oz — shifting to Pd-dominant further reduces cost risk.',
      ...
      },
      {
        ...
        lev: 'Consolidation',
        save: '€20-40/unit (delete underfloor TWC housing and associated plumbing)',
      ...
      },
      {
        ...
        lev: 'Standardization',
        save: '€60-120K manifold tooling NRE per variant + €8-15/unit piece-price volume benefit',
        ...
        mfg: 'One gravity-tilt or lost-foam manifold casting tool (€60-120K) replaces 2-3 derivative tools (€150-280K combined). Common casting simplifies foundry scheduling, alloy specification and quality management. Piece-price benefits from volume consolidation on one cast part vs split volumes.',
      ...
      },
      {
        ...
        lev: 'Material',
        save: '€3-8/unit heat shield assembly',
...
export const FUEL_EMISSION_TRENDS: FuelEmissionTrend[] = [
  {
    ...
    save: 'Delete underfloor TWC can: €20-40/unit',
  ...
  },
  {
    ...
    save: 'Delete separate DPF housing: €25-50/unit',
  ...
  },
  {
    ...
    save: 'Delete PFI sub-system: €25-45/unit',
  ...
  },
  {
    ...
    save: 'Delete purge valve system: €12-22/unit',
  ...
  },
  {
    ...
    status: 'Mainstream',
    save: 'NRE tooling saved: €90-150K per derivative',
  ...
  },
  {
    ...
    status: 'Emerging → Mainstream',
    save: 'Substrate cost −15-25%: €5-12/unit',
  ...
  },
  {
    ...
    status: 'Emerging',
    save: 'Delete external reference hardware: €8-15/unit',
...
export const FUEL_EMISSION_MFG_LEVERS: FuelEmissionMfgItem[] = [
  {
    ...
    lev: 'Standardization',
    save: '€40-80K NRE tooling per derivative avoided',
...
export const FUEL_EMISSION_OEM_BENCHMARKS: FuelEmissionBenchmark[] = [
  ...
  },
  {
    ...
    moves: [
      ...
      'GDI-only TSI Evo 2 (2023): deleted PFI injectors/rail saving €28/unit; LSPI managed by calibration and outward-opening GDI injector',
  ...
  },
  {
    ...
    moves: [
      'BASF SCRF on B47 Euro 6e (2022): combined DPF+SCR substrate — deleted separate DPF housing, saving €32/unit at system level',
  ...
  },
  {
    ...
    moves: [
      'PureTech 1.2 Euro 6e: Umicore 4WC (TWC+GPF) close-coupled — deleted underfloor TWC can, saving €22/unit; 2 aftertreatment bricks vs prior 3',
      'BlueHDi Euro 6e/7: Johnson Matthey SCRF eliminating separate DPF housing — aftertreatment simplification saving €30/unit',
      'PHEV (Citroën C5 X, DS 7 PHEV): sealed EVAP architecture (Continental sealed tank valve) — deleted purge valve system saving €15/unit',
