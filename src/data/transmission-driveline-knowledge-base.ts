...
export const TRANSMISSION_OEM_BENCHMARKS = [
  { oem: 'ZF', model: '8HP / TraXon / 9-Speed / 2-Speed EV', moves: ['8HP fluid-for-life (ZF Lifeguard 9): eliminate all ATF service events over 10-year/160K km life — confirmed BMW 5-Series, Range Rover Sport — saves €145/service × 3 events = €435 lifetime value', '9-speed 9HP transmission: deeper overdrive (0.65:1 9th gear) reduces highway ICE rpm by 180 rpm vs 8HP on same engine — 2.1% fuel saving confirmed Chrysler/Jeep applications', '2-speed EV gearbox (ZF EVS, Rivian Gen 2): 2-speed enables 20% motor active-material reduction at same top speed and performance — motor 20% lighter via reduced peak torque requirement', 'eConnect electrohydraulic front disconnect: 60 ms AWD engagement, 2 mm parasitic drag elimination when decoupled at speed — confirmed BMW xDrive, Mercedes 4MATIC+ applications'] },
  { oem: 'BorgWarner', model: 'iDM 3-in-1 / eGear 2-Speed / eFuse Disconnect / TVM', moves: ['iDM 3-in-1 (motor + inverter + gearbox single housing, ID.4/ID.7): eliminates inter-unit HV connector, 2.4 kg housing saving, 15% part-load efficiency improvement vs modular system', 'eGear 2-speed EV transmission (BAIC ARCFOX α-S confirmed 2024): enables 20% motor copper saving at identical range and 0–100 performance — gear ratio optimisation eliminates motor overspec', 'eFuse active front disconnect: electro-mechanical jaw clutch <200 ms — replaces constant mesh helical gear drag when AWD not needed, saves 2.1 Nm parasitic loss at 100 km/h', 'Torque Vectoring Module (TVM): planetary gear set + 2 friction clutches → ±80 Nm left/right rear torque split — software-defined vectoring add-on to base differential'] },
  { oem: 'GKN Automotive', model: 'eAxle / eConnect / IWM / eTwinster', moves: ['eAxle 3-in-1 (Porsche Macan EV, Jeep 4xe): saves 3 HV connector interfaces vs modular design, 12% total drive unit efficiency improvement at part load — 1 coolant circuit vs 3 separate', 'eConnect electrohydraulic clutch (BMW xDrive, Mercedes 4MATIC+): 60 ms AWD engagement, 2 Nm parasitic drag eliminated vs permanent AWD — confirmed production across 5 OEM platforms', 'In-wheel motor prototype (Zeekr/GKN, 4 × 80 kW axial-flux): eliminates gearbox (4.2 kg), prop shaft (3.8 kg), differential (5.1 kg), half-shafts (4.4 kg) — 17.5 kg drivetrain saving per axle', 'eTwinster torque vectoring rear (BMW M3 G81 xDrive): ±100% torque bias per rear wheel via independent planetary gear sets — delete mechanical LSD (€320), faster yaw response'] },
  { oem: 'Porsche / Audi', model: 'PDK Gen4 / PTV+ / e-diff / PPE Gear Sharing', moves: ['PDK Gen4 (Taycan/Panamera): 96.8% peak efficiency vs 94.5% torque converter AT, zero torque converter slip — clutch pre-charge algorithm enables launch at full torque without slip', 'PTV+ software torque vectoring (Cayenne/Macan): delete rear mechanical LSD entirely — €320/vehicle saving, 20 ms response vs 200 ms mechanical, via independent electric rear axle motors', 'Audi software e-diff (RS e-tron GT VTV): front/rear motor current torque vectoring replaces Torsen mechanical centre differential — €340 saving, 4.8 kg lighter, <10 ms response', 'PPE platform gear set commonisation (Q6 e-tron + Macan EV): single 9.1:1 ratio gear set shared across both — NRC tooling saving €2.4M, CATL cell + gear supplier volume pooled'] },
  { oem: 'Toyota', model: 'THS-II Power Split / PHEV Integration / iMT / e-Axle', moves: ['THS-II (2.5L Atkinson): power-split epicyclic — no conventional gearbox, no torque converter; generator sets virtual ratio continuously — zero shift shock, 97% efficiency at highway cruise', 'RAV4 Prime/Lexus NX 450h+ rear e-axle: completely decoupled from front transaxle, no prop shaft — torque-on-demand AWD via CAN command only, saves 3.2 kg prop shaft + coupling', 'GR Corolla iMT (intelligent Manual): automated clutch for hill-hold + launch control — delete dedicated hill-hold hardware module (€28/vehicle), clutch servo performs function via clutch-by-wire', 'PHEV P2 motor integration (Lexus, Toyota Prime): P2 motor shares ATF lubrication with main transaxle — delete separate P2 motor oil cooler loop (shared ATF heat exchanger)'] },
  { oem: 'BYD', model: 'DM5 DHT / DM-i Super Hybrid / 8-in-1 e-Axle / ePTU', moves: ['DM5 2-speed DHT (Han L/Seal L): 97.5% gearbox efficiency, delete torque converter (€185, 5.1 kg) — enables pure EV city mode + highway efficiency with simple 2-speed mechanical path', 'DM-i EV-dominant DHT: 1.5L NA engine at fixed 43% thermal efficiency as range extender — engine never drives through gearbox directly, all gear sets serve motor-to-wheel path only', 'BYD 8-in-1 e-axle (e-Platform 3.0): motor + inverter + OBC + DC-DC + PDU + BMS + VCU + MCU in single Al housing — delete 7 inter-unit HV connectors, 3 coolant interfaces, 2.8 kg housing', 'ePTU front electric power transfer unit (Yangwang U8 4WD PHEV): replaces mechanical transfer case and front prop shaft entirely — fully electric 4WD, saves 18 kg vs NV245 mechanical case'] },
];
