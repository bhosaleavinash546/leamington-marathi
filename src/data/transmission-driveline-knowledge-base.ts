    ...
    levers: [
      {
        ...
        saving: '£153–272/transmission at volume >80K units/yr; ZF offers fleet-rate rebate on 8HP when OEM shares calibration data and drops derivative gearsets',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£30–47/unit: delete ATF/coolant HEX, brackets, coolant lines routed to gearbox; use larger pan-mounted oil cooler (£15–19 vs £47–60 HEX)',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '£21–34/vehicle in ECU calibration + validation cost; £68K–170K NRE saving per programme by reusing validated shift maps',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£10–15/unit in sump; delete £6.8–12 steel undershield → net ~£4.3–10 saving per vehicle with mass reduction of 0.9 kg',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '£1.3–3/vehicle at OEM fluid fill; £6.8–13/service event over life; improves dealer profitability on LCV / independent service',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£77–128/gearbox set at volume; requires £38.25M–59.5M capex investment amortised over 7-yr programme — positive NPV at >120K/yr and 2+ derivatives',
        conf: 'estimated',
    ...
    levers: [
      {
        ...
        saving: '£47–72 BOM delta vs full-time viscous; fuel economy +0.4–0.8 l/100km (RDE cycle) from disconnect in 2H mode — relevant for EU WLTP fleet CO2 compliance',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£119–179 transfer case BOM delete; add £72–94 rear eDiff ECU function; net £47–85 saving + 14 kg mass reduction; valid on wheelbase >3.0m long-range spec only',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '£19–32/unit: delete external oil pump assembly; Al casting ~£24 vs stamped steel housing + pump £41–51 on steel; mass saving 2.8–3.5 kg',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£38–60 standalone ECU delete; calibration validation cost saving £102K per programme; software integration in DPTCM is £12.8K NRE uplift',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '£13–24/vehicle: delete TC oil cooler unit (£19–30), tap into existing ATF oil circuit (£6.8–10 tee and valve); valid for road/light off-road spec only',
        conf: 'estimated',
    ...
    levers: [
      {
        ...
        saving: '£6.8–13/front shaft pair in manufacturing (tripod joint lower NVH rework rate vs 6-ball at high angle); warranty -30% on CV joint warranty claims at >100K km off-road fleet',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£15.3K–38.3K tooling NRE saving per platform; identical forged tripod housing + calibrated plunge; 2 variants → 1 P/N for housing (boot + grease differentiates)',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£2.1–3.4/boot (Hytrel premium vs EPDM rubber); warranty saving £30–47/vehicle on cold-climate markets (Norway, Canada, Russia) over 3yr/60K warranty period',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£5.1–8.5/shaft: delete spline sleeve insert (£3.4–5.1); induction hardening of one-piece: £2.5–3.4 process uplift; net £1.7–5.1 saving + 180 g mass reduction',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '1.2–1.8 kg mass saving per rear shaft pair; £10–17 unit cost premium over solid (friction weld process); net BIL (body-in-life) warranty benefit from lower unsprung mass — justify by NCAP dynamic score (steering feel)',
        conf: 'estimated',
    ...
    levers: [
      {
        ...
        saving: '£38–64/vehicle: CF propshaft ~£102–119 vs two-piece steel (£51–64 tube + £21–34 bearing assy + £13–19 bracket); mass saving 4.5–6.5 kg; delete 3 components → 1',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£1.5–2.2/centre bearing (PU premium); warranty saving £24–43/vehicle on AWD SUV fleet (centre bearing failure accounts for 12–18% AWD warranty cost per JLR warranty database)',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£298K–510K tooling NRE saving: 2 P/Ns → 1; phased yoke costs £6.8K NRE to validate vs £170K+ for separate tooling per shaft variant',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '£3–5.1/vehicle in deleted grease fittings and plugs; fleet owner saves £21–34/vehicle/service event in labour; relevant for Defender Commercial and Range Rover commercial spec',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£3.4–6.8/propshaft: delete 4 bolts + shims; automated weld eliminates manual assembly (45 sec → 12 sec); £51K–76.5K robot investment recoverable at >40K/yr volume',
        conf: 'estimated',
    ...
    levers: [
      {
        ...
        saving: '£21–38 BOM saving (eLSD actuator £55–68 vs Torsen T2R £81–102 at volume); enable front TVC feature (£170+ customer option uplift) with hardware already installed; net positive margin per unit',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£102K–213K tooling saving (remove 2 ring-pinion gear sets); £10–15/unit carrier cost saving at volume; small WLTP CO2 impact (±1 g/km) manageable via TCU calibration',
        conf: 'benchmarked',
      ...
      },
      {
        ...
        saving: '£81–123/vehicle: delete mechanical locking diff actuator (£72–94) + actuation harness; DPTCM eLSD function via existing brake ECU costs £10–15 in software; valid on variants where axle articulation <22°',
        conf: 'estimated',
      ...
      },
      {
        ...
        saving: '£15–27/unit uplift (Al HPDC vs GJS casting); recover via £12 mass-related savings downstream (suspension, springs, brakes); net £3.4–15 saving per vehicle at large volume; 6.2 kg unsprung mass reduction improves dynamic compliance rating',
        conf: 'verified',
      ...
      },
      {
        ...
        saving: '£323K–553K tooling NRE saving across 2 variants; same HPDC diff case die across D-ratio off-road spec and eLSD road spec (Defender vs Range Rover on same D7x platform)',
        conf: 'estimated',
...
export const TRANSMISSION_TRENDS: TransmissionTrend[] = [
  {
    ...
    status: 'Mainstream',
    impact: 'Rear eAxle eliminates: 2-piece propshaft, rear transfer case output shaft, rear drive shaft UJ. Cost saving £153–238 on deleted mechanical content vs new eAxle cost (£510–723). Net PHEV driveline premium ~£357–485 over PHEV motor cost.',
  },
  {
    ...
    status: 'Mainstream',
    impact: 'CF shaft at £102–119 vs steel two-piece at £85–115 (including centre bearing) — near cost parity. Mass saving 5 kg improves CO2 ~0.3 g/km WLTP. Mainstream at >30K/yr volume by 2025.',
  },
  {
    id: 'intelligent-awd',
    ...
    status: 'Emerging',
    impact: 'Predictive AWD disconnect reduces driveline drag losses 60–80% in 2WD driving → fuel economy +0.6–1.0 l/100km. ECU software cost £6.8–12.8K NRE uplift; hardware same as reactive system.',
  },
  {
    id: 'zf-8hp-universal',
    ...
    status: 'Mainstream',
    impact: '8HP-e integrated MHEV: £0–34 premium over conventional 8HP + separate 48V system (£298–383 combined). CO2 saving 4–7 g/km WLTP. Packaging improvement: removes belt-driven BSG from engine bay.',
  },
  {
    ...
    status: 'Emerging',
    impact: 'TVD BOM £187–289 vs eLSD £81–111 — £77–170 premium. Replaces active suspension torque correction. Customer perceived improvement in steering feel rated highest NCAP Consumer Test metric for luxury SUV 2022–24.',
  },
  {
    id: 'in-wheel-motor',
    ...
    status: 'Next-Gen',
    impact: 'IWM deletes: front/rear differentials, front/rear propshafts, transfer case, half-shafts → £595–808 driveline BOM delete. Adds: 4× motor + inverter (~£1,530–2,040). Net BEV driveline cost premium £723–1,233. Unsprung mass requires active suspension.',
  },
  {
    id: 'lifetime-fluids',
    ...
    status: 'Mainstream',
    impact: 'Dealer service revenue loss £68–102/vehicle over life (oil change delete). OEM warranty cost reduction: ATF seal failures down 40% vs 60K km service — net positive for OEM warranty accrual.',
  },
  {
    ...
    status: 'Next-Gen',
    impact: 'AM titanium diff bracket: £238–383 vs stamped steel £19–30 — cost-prohibitive at volume. Viable for <2,000 units/yr SV Bespoke or motorsport homologation. Lead time: 2 weeks vs 16 weeks for forging tooling.',
  },
];
...
export const TRANSMISSION_MFG_LEVERS: TransmissionMfgLever[] = [
  {
    ...
    saving: '£77–128/gearbox set',
    status: 'Planned',
  },
  {
    id: 'propshaft-friction-weld',
    name: 'Friction Welding for Propshaft Yoke-to-Tube Joint',
    description: 'Automated rotary friction welding eliminates flange bolts and alignment shimming on propshaft assembly. Cycle time 12 sec vs 45 sec manual bolt assembly. Line investment £51K–76.5K per shift.',
    saving: '£3.4–6.8/propshaft + cycle time',
    status: 'Piloting',
  },
  {
    id: 'al-diff-hpdc',
    ...
    saving: '£15–27 net/unit after process uplift',
    status: 'Active',
  },
  {
    ...
    saving: '£13–21/propshaft vs semi-auto process',
    status: 'Active',
  },
  {
    ...
    saving: '£2.5–5.1/CV joint from scrap + energy reduction',
    status: 'Piloting',
  },
];
...
export const TRANSMISSION_OEM_BENCHMARKS = [
  { oem: 'ZF', model: '8HP / TraXon / 9-Speed AT', moves: ['8HP fluid-for-life (ZF Lifeguard 9): eliminate all transmission ATF service events over 10-year/160K km life — confirmed BMW 5-Series, Range Rover — saves £123/service × 3 events = £370/vehicle lifetime', '9-speed automatic (9HP, ZF): 9-speed enables deeper overdrive vs 8HP — 0.65:1 9th gear reduces highway ICE rpm 180 rpm, 2.1% fuel saving vs 8HP on same engine', '2-speed EV gearbox (ZF EVS, Rivian Gen2): 2-speed enables 20% motor active-material reduction at same top speed — motor 20% lighter at equal performance', 'EV disconnect unit (ZF eConnect): electrohydraulic front-axle disconnect adds all-wheel drive capability to RWD BEV — 60 ms engagement, 25 mm parasitic drag elimination when decoupled'] },
  { oem: 'BorgWarner', model: 'iDM / eGear / eFuse / Torque Vectoring Module', moves: ['iDM 3-in-1 (motor + inverter + gearbox single housing): BorgWarner 3-in-1 for Volkswagen ID.4/7 — eliminates inter-unit HV connector, 2.4 kg housing saving, 15% efficiency at part load vs modular', 'eGear 2-speed (BorgWarner P-type): 2-speed EV gearbox enabling 20% motor copper saving at identical range and performance — confirmed BAIC ARCFOX α-S 2024', 'eFuse active disconnect (front axle): electro-mechanical jaw clutch engagement <200 ms — replaces constant mesh helical gear drag when AWD not needed (parasitic loss 2.1 Nm @ 100 km/h)', 'Torque Vectoring Module (TVM): planetary gear set with 2 friction clutches → left/right rear torque split ±80 Nm — software-only vectoring delta on top of base differential'] },
  { oem: 'GKN Automotive', model: 'eAxle / eConnect / IWM Prototype / Torque Vectoring', moves: ['eAxle 3-in-1 (motor + inverter + gear reduction, GKN eDrive): production on Porsche Macan EV, Jeep 4xe — saves 3 HV connector interfaces vs modular, 12% total drive unit efficiency improvement', 'eConnect electrohydraulic clutch (front axle): 60 ms AWD engagement — 2 Nm parasitic drag eliminated vs permanent AWD; confirmed BMW xDrive, Mercedes 4MATIC+', 'In-wheel motor prototype (Zeekr/GKN collaboration): 4 × 80 kW axial-flux IWM — eliminates gearbox (4.2 kg), prop shaft (3.8 kg), diff (5.1 kg), half-shafts (4.4 kg) per axle', 'Torque vectoring eAxle (GKN eTwinster): independent gear sets per output shaft → ±100% torque bias per wheel — BMW M3xDrive torque vectoring rear axle (confirmed G81)'] },
  { oem: 'Porsche / Audi', model: 'PDK Gen4 / e-diff / PPE Gear Set', moves: ['PDK Gen4 (Taycan Sport Turismo): 7-speed dual-clutch, no torque converter — 96.8% peak efficiency vs 94.5% torque converter AT, zero slip at launch via clutch pre-charge algorithm', 'Porsche Torque Vectoring (PTV+): software delete rear mechanical LSD — £272/vehicle saving, 20 ms response vs 200 ms mechanical, enabled by independent electric rear axle', 'Audi software e-diff (RS e-tron GT): front/rear motor current control torque vectoring — replaces Torsen mechanical centre diff (£289 4.8 kg) entirely via VTV SW on Bosch MCU', 'PPE platform common gear set (Audi Q6 e-tron / Macan EV): single gear ratio 9.1:1 shared across both nameplates — NRC saving £2.04M tooling, CATL cell supply + gear supply pooled'] },
  { oem: 'Toyota', model: 'THS-II / Power Split DHT / PHEV e-Motor', moves: ['THS-II (2.5L Atkinson hybrid): power-split epicyclic — no conventional gearbox, no torque converter; generator sets virtual gear ratio continuously — zero shift shock, 97% efficiency at highway cruise', 'Toyota PHEV e-motor integration (Prime range): P2 motor integrated into transaxle, shares ATF lubrication circuit with engine — delete P2 motor oil cooler (shared ATF heat exchanger)', 'GR Corolla iMT (intelligent Manual Transmission): automated clutch control at hill-hold + launch control — delete hill-hold hardware module (£24/vehicle), clutch servo does function', 'e-Axle rear (RAV4 Prime, Lexus NX 450h+): standalone rear electric axle — completely decoupled from front transaxle (no prop shaft), torque-on-demand AWD software via CAN only'] },
  { oem: 'BYD', model: 'DM5 DHT / DM-i Super Hybrid / 8-in-1 e-Axle', moves: ['DM5 2-speed DHT (Han L/Seal L): dedicated hybrid transmission replaces conventional AT + belt alternator — 97.5% gearbox efficiency at highway cruise, delete torque converter (£157 5.1 kg)', 'DM-i super hybrid (EV-dominant DHT): 1.5L naturally aspirated engine runs at 43% thermal efficiency fixed-speed range-extender — delete all gear sets except 2-speed DHT, engine never drives through gearbox directly', 'BYD 8-in-1 e-axle (e-Platform 3.0): motor + inverter + OBC + DC-DC + PDU + BMS + VCU + MCU in single Al housing — delete 7 inter-unit HV connectors, 3 coolant interfaces, 2.8 kg housing saving', 'ePTU evolution (BYD for Yangwang U8 4WD PHEV): front electric PTU replaces mechanical transfer case — fully electric 4WD without prop shaft, saves 18 kg vs conventional NV245 case'] },
];
