...
export const HVAC_OEM_BENCHMARKS = [
  { oem: 'Valeo', model: 'Valeo ThermoSystem / R744 CO₂ Compressor', moves: ['ThermoSystem 8-in-1 thermal management block (BEV): integrates heat pump compressor, OBC, DC-DC, battery heater, chiller, coolant pump in one Al housing — delete 7 separate component brackets', 'R744 CO₂ electric compressor (Valeo Compleo): –30°C heat pump capable, COP 2.1 at –10°C — enables range-extended winter driving without LiDAR heater delete', 'Smart thermal valve (7-port proportional valve, Valeo): replaces 6 ON/OFF 2-way valves — 1 actuator manages all coolant routing, saves €32/vehicle', 'OBC + DC-DC combined unit (Valeo E3): 11 kW OBC + 3.3 kW DC-DC in single housing, liquid-cooled — delete separate DC-DC housing and 2 coolant connections'] },
